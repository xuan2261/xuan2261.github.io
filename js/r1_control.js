...
var dev_name = ""; // Định danh ngắn của thiết bị, được tạo từ hostname

// Xử lý lỗi toàn cục được quản lý bởi ErrorHandler
...
var buttons = [
  [
    "Play Music",
    {
      ...
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 1, obj: "web_播放" },
      type: 1,
      min_ver: 1600,
      min_uver: 1700,
      err: "Please enter the music to play, e.g., Artist Song Title!",
  ...
  [
    "Play Radio",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 1, obj: "web_收听" },
      type: 1,
      min_ver: 1600,
      min_uver: 1700,
      err: "Please enter the radio station name, e.g., Shandong Music Radio!",
      succ: "Request sent successfully!",
    },
  ],
  [
    "Play Playlist",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 9, obj: "" },
      type: 1,
      min_ver: 1700,
      min_uver: 1700,
      err: "Please enter the playlist link, e.g., https://y.qq.com/n/ryqq/playlist/211111!",
      succ: "Request sent successfully!",
    },
  ],
  ...
  [
    "Personal Radio",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 1, obj: "web_播放个性电台" },
      type: 0,
      min_ver: 1600,
      min_uver: 1700,
      succ: "Okay, playing personal radio!",
    },
  ], // Kept original Chinese in obj
  [
    "My Playlists",
    { type: -1, min_ver: 1600, min_uver: 1800, itemType: "get_song_list" },
  ],
  [
    "Unisound Favorites",
    {
      ws_type: "send_message",
      param: { what: 65536, arg1: 0, arg2: 8 },
      type: 0,
      min_ver: 1700,
      min_uver: 1700,
      succ: "Okay, playing Unisound favorites playlist!",
    },
  ],
  [
    "Local Music",
    { type: -1, min_ver: 1853, itemType: "play_local_music", max_ver: 1855 },
  ],
  [
    "Local Music",
    {
      type: -1,
      itemType: "play_local_music",
      min_ver: 1856,
      max_ver: 1864,
      state: ["info.Current_PlayerType", [1]],
    },
  ],
  [
    "Local Music",
    {
      ...
      itemType: "play_local_music",
      min_ver: 1865,
      state: ["info.Current_PlayerType", [1, 2]],
    },
  ],
  [
    "Turn On Bluetooth",
    {
      ws_type: "send_message",
      param: { what: 64, arg1: 1, arg2: -1 },
      type: 0,
      max_ver: 1810,
      max_uver: 1000,
      succ: "Bluetooth enabled!",
    },
  ],
  [
    "Turn On Bluetooth",
  ...
  [
    ...
    {
      ws_type: "send_message",
      param: { what: 64, arg1: 2, arg2: -1 },
      type: 0,
      max_ver: 1810,
      succ: "Bluetooth disabled!",
    },
  ],
  [
    ...
    {
      ws_type: "send_message",
      param: { what: 4, arg1: 64, arg2: 1 },
      type: 0,
      max_ver: 1810,
      succ: "Ambient light turned on!",
    },
  ],
  [
    ...
    {
      ws_type: "send_message",
      param: { what: 4, arg1: 64, arg2: 0 },
      type: 0,
      max_ver: 1810,
      succ: "Ambient light turned off!",
    },
  ],
  ...
  [
    ...
    {
      ws_type: "send_message",
      title: ["Bluetooth (Off)", "Bluetooth (On)"],
      tips: ["Turn On Bluetooth", "Turn Off Bluetooth"],
      param: [
        { what: 64, arg1: 1, arg2: -1 },
        { what: 64, arg1: 2, arg2: -1 },
      ],
      type: 2,
      min_ver: 1820,
      max_uver: 1000,
      is_unisound: false,
      succ: ["Bluetooth enabled!", "Bluetooth disabled!"],
      state: [0, "info.device_state", [[0, 1, 2], 3]],
    },
  ],
  [
    "Turn On Bluetooth",
  ...
  [
    "Turn On Bluetooth",
    {
      ...
      min_uver: 1001,
      succ: ["Bluetooth enabled!", "Bluetooth disabled!"],
      state: [0, "info.device_state", [[0, 1, 2, 5], 3]],
    },
  ],
  [
    "Execute Command",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 1, obj: "web_" },
      type: 1,
      min_ver: 1600,
      min_uver: 1839,
      err: "Please enter the command to execute, e.g., Tomorrow's weather!",
      succ: "Command sent!",
    },
  ],
  [
    "Execute Shell",
    {
      ...
      param: { shell: "" },
      type: 1,
      err: "Please enter the shell command to execute, e.g., getprop!",
    },
  ],
  [
    "Reboot Unisound",
    { type: -1, is_unisound: true, itemType: "reboot_unisound" },
  ],
  ...
  [
    ...
    {
      ws_type: "send_message",
      title: ["Ambient Light (Off)", "Ambient Light (On)"],
      tips: ["Turn On Ambient Light", "Turn Off Ambient Light"],
      param: [
        { what: 4, arg1: 64, arg2: 1 },
        { what: 4, arg1: 64, arg2: 0 },
      ],
      type: 2,
      min_ver: 1820,
      succ: ["Ambient light turned on!", "Ambient light turned off!"],
      state: [0, "info.music_light_enable", [false, true]],
    },
  ],
  [
    "Modify Device Name",
    {
      ws_type: "set_dev_name",
      input: "dev_name",
      param: { dev_name: "" },
      type: 1,
      min_ver: 1841,
      err: "Please enter the new device name!",
      succ: "Device name modified successfully!\nChanges for Bluetooth/DLNA/AirPlay will take effect on next startup!",
    },
  ],
  [
    "Modify Unisound Wake Word",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, arg1: 0, arg2: 3, obj: "" },
      type: 1,
      min_uver: 1600,
      err: "Please enter the new Unisound wake word!",
      succ: "Unisound wake word modified successfully!\nTip: The default '小讯小讯' wake word will still be available!",
    },
  ], // Kept original default wake word
  [
    "Enable Xiaoai Wakeup",
    {
      ws_type: "send_message",
      is_unisound: true,
      title: ["Enable Xiaoai Wakeup", "Disable Xiaoai Wakeup"],
      param: [
        {
          what: 65536,
          arg1: 0,
          arg2: 10,
          obj: { type: "set_wakeup_xiaoai", enable: true },
        },
        {
          what: 65536,
          arg1: 0,
          arg2: 10,
          obj: { type: "set_wakeup_xiaoai", enable: false },
        },
      ],
      type: 2,
      min_uver: 1837,
      succ: ["Xiaoai wakeup enabled!", "Xiaoai wakeup disabled!"],
      state: [
        2,
        "Unisound_info.Wakeup_Xiaoai",
        [false, true],
        ["Unisound_info.is_xiaoai_exists", true],
      ],
    },
  ],
  [
    "Modify Xiaoai Wake Word",
    {
      ws_type: "send_message",
      input: "obj.word",
      param: {
        ...
        arg1: 0,
        arg2: 10,
        obj: { type: "set_wakeup_xiaoai_word", word: "" },
      },
      type: 1,
      min_uver: 1837,
      err: "Please enter the new Xiaoai wake word!",
      succ: "Xiaoai wake word modified successfully!",
      state: ["Unisound_info.is_xiaoai_exists", [true]],
    },
  ],
  ...
  [
    "Xiaoai Settings Page",
    {
      type: -1,
      itemType: "xiaoai_settings",
      state: ["Unisound_info.is_xiaoai_exists", [true]],
    },
  ],
  [
    "Reboot Xiaoai Service",
    {
      type: -1,
      itemType: "reboot_xiaoaiservice",
      state: ["Unisound_info.is_xiaoai_exists", [true]],
    },
  ],
  [
    "Activate Xiaoai (One-Click)",
    {
      type: -1,
      itemType: "activation_xiaoai",
      state: ["Unisound_info.xiaoai_vercode", [902010020]],
    },
  ],
  [
    "Set Voice Time Reporting",
    { type: -1, itemType: "Voice_time_reporting", min_uver: 1832 },
  ],
  [
    "Set Auto Reboot",
    { type: -1, itemType: "Auto_restart_device", min_ver: 1848 },
  ],
  [
    "Set Ambient Light Brightness",
    {
      ws_type: "send_message",
      input: "arg2",
      param: { what: 4, arg1: 65, arg2: "" },
      type: 1,
      err: "Please enter the brightness (default 100, min 1, max ~200 recommended)!",
      succ: "Ambient light brightness modified successfully!",
    },
  ],
  [
    "Switch to Official Ambient Effect",
    {
      ws_type: "send_message",
      param: { what: 4, arg1: 67, arg2: 0 },
      type: 0,
      max_ver: 1500,
      succ: "Switched to official ambient effect!",
    },
  ],
  [
    "Switch to Colorful Ambient Effect",
    {
      ws_type: "send_message",
      param: { what: 4, arg1: 67, arg2: 1 },
      type: 0,
      max_ver: 1500,
      succ: "Switched to colorful ambient effect!",
    },
  ],
  [
    "Switch to Official Ambient Effect",
  ...
  [
    "Switch Colorful Ambient Effect",
    {
      ws_type: "send_message",
      title: [
        "Current: Official Effect",
        "Current: Colorful Effect",
        "Current: Colorful Rotating",
        "Current: Colorful Rotating 1",
        "Current: Single Color",
      ],
      param: [
        { what: 4, arg1: 68, arg2: 2 },
        { what: 4, arg1: 68, arg2: 1 },
        { what: 4, arg1: 68, arg2: 3 },
        { what: 4, arg1: 68, arg2: 4 },
        { what: 4, arg1: 68, arg2: 0 },
      ],
      type: 2,
      min_ver: 1848,
      succ: [
        "Switched to colorful ambient!",
        "Switched to colorful rotating!",
        "Switched to colorful rotating 1!",
        "Switched to single color!",
        "Switched to official ambient!",
      ],
      state: [0, "info.music_light_mode", [0, 2, 1, 3, 4]],
    },
  ],
  [
    "Set Color Gradient Speed",
    {
      ws_type: "send_message",
      input: "arg2",
      param: { what: 4, arg1: 66, arg2: "" },
      type: 3,
      err: "Please enter speed (default 4, min 0, max 100)!",
      succ: "Ambient light color gradient speed modified successfully!",
      state: ["info.music_light_mode", [0, 1, 3]],
      hide: true,
    },
  ],
  [
    ...
    {
      type: -1,
      itemType: "modify_color",
      state: ["info.music_light_mode", [4]],
      hide: true,
    },
  ],
  ...
  [
    ...
    {
      ws_type: "shell",
      param: { shell: "lights_test set 7fffff8000 ffffff" },
      type: 0,
      succ: "Turned on!",
    },
  ],
  [
    ...
    {
      ws_type: "shell",
      param: { shell: "lights_test set 7fffff8000 0" },
      type: 0,
      succ: "Turned off!",
    },
  ],
  [
    "TTS",
    {
      ws_type: "send_message",
      input: "obj",
      param: { what: 65536, obj: "" },
      type: 1,
      min_uver: 1800,
      err: "Please enter the text to speak",
      succ: "",
    },
  ],
  ...
  [
    "Set IOT_API",
    {
      ...
      param: {
        ...
        arg1: 0,
        arg2: 10,
        obj: '{"type":"set_iot_api","iot_api":""}',
      },
      type: 1,
      min_uver: 1816,
      err: 'Please enter the API, e.g., http://r1.wxfsq.com/iot.php, Example response: {"status":200,"message":"ok","text":"tts content"}',
      succ: "IOT_API set successfully!",
    },
  ],
  [
    "Upload Software Update",
    { type: -1, min_ver: 1835, itemType: "upload_page" },
  ],
  ...
  [
    "Allow DLNA Service Start",
    {
      ...
      title: ["DLNA Service (Disabled)", "DLNA Service (Enabled)"],
      tips: ["Allow DLNA Service Start", "Forbid DLNA Service Start"],
      param: [{ open: true }, { open: false }],
      type: 2,
      min_ver: 1852,
      succ: [
        "Allowed!",
        "Forbidden, will take effect after current service disconnects!",
      ],
      state: [0, "info.dlna_open", [false, true]],
    },
  ],
  [
    "Allow AirPlay Service Start",
    {
      ws_type: "Set_AirPlay_Open",
      title: ["AirPlay Service (Disabled)", "AirPlay Service (Enabled)"],
      tips: ["Allow AirPlay Service Start", "Forbid AirPlay Service Start"],
      param: [{ open: true }, { open: false }],
      type: 2,
      min_ver: 1852,
      succ: [
      ...
      state: [0, "info.airplay_open", [false, true]],
    },
  ],
  [
    "Keep Bluetooth/DLNA/AirPlay Always On",
    {
      ws_type: "Set_Service_Normally_Open",
      title: [
        "BT/DLNA/AirPlay Always On (Off)",
        "BT/DLNA/AirPlay Always On (On)",
      ],
      tips: [
        "Enable BT/DLNA/AirPlay Always On",
        "Disable BT/DLNA/AirPlay Always On",
      ],
      param: [{ open: true }, { open: false }],
      type: 2,
      min_ver: 1840,
      succ: ["Enabled!", "Disabled!"],
      state: [0, "info.Service_Normally_Open", [false, true]],
    },
  ],
...
window.onload = function () {
  ...
  setTimeout(function () {
    ...
    background_div.style =
      "z-index: -1; position: fixed; left: 0px; top: 0px; width:100%; height:100%";
    ...
    if (
      location.href.indexOf("noimg") == -1 &&
      location.href.indexOf(control_host) == -1
    ) {
    ...
    if (params != null) {
      if (!params.hasOwnProperty("no_auto_connect")) {
        ...
        if (params.hasOwnProperty("connect_ip")) {
          ...
          if (
            !reg_ip.test(connect_ip) &&
            !/phicomm_r1_\S+/u.test(connect_ip.toLowerCase())
          ) {
            connect_ip = -1;
          }
        }
...
function custom_ip_page() {
  ...
  if (ip_connect) {
    var tmp_ip = Storage.getItem("ip")
      ? Storage.getItem("ip")
      : Storage.getItem("hostname");
  } else {
    var tmp_ip = Storage.getItem("hostname")
      ? Storage.getItem("hostname")
      : Storage.getItem("ip");
  }
  ...
  if (device_list) {
    ...
    if (control_host && control_host.indexOf("r1.wxfsq.com") > -1) {
      // Check if using original host
      $.ajax({
        async: false,
        type: "POST",
        url: "./ip",
  ...
  if (device_list != null) {
    ...
    device_select_list.style =
      "display:block;margin:10px auto;width:70%;height:50px;font-size: 16px;color: rgba(238, 0, 0, 1);border-color: rgba(0,160,255,1);outline: none;background:rgba(255, 255, 255, 0.2);border-radius: 15px;";
    device_select_list.onchange = function () {
      var input = document.getElementById("input");
      if (
        ip_connect &&
        this.options[this.selectedIndex].getAttribute("ip") != ""
      ) {
      ...
      input.setAttribute(
        "connect_id",
        this.options[this.selectedIndex].getAttribute("connect_id")
      );
    ...
    for (var i = 0; i < arr.length; i++) {
      ...
      if (
        arr[i].ip == tmp_ip ||
        arr[i].hostname.toLowerCase() == tmp_ip.toLowerCase() ||
        (connect_id != null && connect_id == id) ||
        (connect_ip != -1 &&
          (arr[i].ip == connect_ip ||
            arr[i].hostname.toLowerCase() == connect_ip.toLowerCase()))
      ) {
        if (ip_connect) {
      ...
      for (var i = 0; i < device_select_list.options.length; i++) {
        ...
        if (
          this.value.toLowerCase() ==
            option.getAttribute("hostname").toLowerCase() ||
          this.value == option.getAttribute("ip")
        ) {
  ...
  btn.onclick = function () {
    if (ip_connect) {
      if (
        !confirm(
          "After switching, you will connect using the device name. Continue?"
        )
      ) {
        // Dịch
        return;
      ...
      if (
        !confirm(
          "After switching, you will connect using the IP address. Continue?"
        )
      ) {
        // Dịch
        return;
  ...
  if (device_select_list != null && device_select_list.options.length > 0) {
  ...
  // Nút quét IP và các phần tử liên quan đã bị ẩn hoàn toàn theo yêu cầu
  ...
  if (reg_ip.test(tmp_ip) || /phicomm_r1_\S+/u.test(tmp_ip.toLowerCase())) {
    ...
    if (!location.href.includes("no_auto_connect")) {
      main_div.onclick = function () {
        ...
        setTimeout(function () {
          if (h3.innerHTML == "Auto-connect cancelled!") {
            // Dịch
            if (document.getElementById("device_list")) {
              h3.innerHTML =
                "Please select or enter speaker IP/Hostname to connect!"; // Dịch
            } else {
      ...
      h3.innerHTML =
        "Last connection detected, auto-connecting in 2 seconds. Click blank area to cancel!"; // Dịch
      connect_timer = setTimeout(function () {
        main_div.onclick = function () {};
        if (
          document.getElementById("get_ip_btn") &&
          document.getElementById("get_ip_btn").style.display != "none"
        ) {
      ...
      for (var i = 0; i < device_select_list.options.length; i++) {
        ...
        if (
          input.value.toLowerCase() ==
            option.getAttribute("hostname").toLowerCase() ||
          input.value == option.getAttribute("ip")
        ) {
          hostname = option.getAttribute("hostname");
...
// Chức năng quét thiết bị trong mạng đã bị ẩn theo yêu cầu
...
function test_connect() {
  ...
  if (!reg_ip.test(ip) && !/phicomm_r1_\S+/u.test(ip.toLowerCase())) {
    ...
    try {
      // Add try-catch for WebSocket creation
      ws = new WebSocket(ws_address);
    } catch (e) {
      h3.innerHTML =
        "Failed to create WebSocket. Check address/hostname and port."; // Dịch
    ...
    ws.onopen = function (data) {
      ...
      if (inputElement) {
        ...
        connect_id =
          connect_id != "" && connect_id != null && connect_id != "undefined"
            ? connect_id
            : null;
      } else {
      ...
      if (customIpPage && divs.contains(customIpPage)) {
        // Check if exists and is child
      ...
      if (reg_ip1.test(input_ip.value)) {
        // Check the original input value
        window.Storage.removeItem("hostname");
        window.Storage.setItem("ip", input_ip.value);
      } else {
        window.Storage.removeItem("ip");
    ...
    ws.onclose = function (data) {
      ...
      if (data.code == 1006) {
        ...
        var msg =
          "Failed to connect to speaker (Code: 1006). Please ensure new_EchoService is installed!\nCheck if the IP/Hostname is correct or reboot the speaker and try again!"; // Dịch
        alert(msg);
        ...
        h3.innerHTML =
          "Disconnected (Code: " + data.code + "). Reconnecting..."; // Dịch
    ...
    ws.onerror = function (error) {
      ...
      alert(
        "WebSocket error. Please check the IP/Hostname, port, and network connection. Error: " +
          error
      ); // Dịch
    ...
    test_connect_timeout_timer = setTimeout(function () {
      if (!test_connect_state) {
        ...
        var msg =
          "Connection timed out. Please ensure new_EchoService is installed!\nCheck if the IP/Hostname is correct or reboot the speaker and try again!"; // Dịch
        alert(msg);
      }
...
function init() {
  ...
  if (
    ...
    if (ws == null || ws.readyState != WebSocket.CONNECTING) {
      try {
        ...
        ws = new WebSocket(ws_address);
        if (h3_init)
          h3_init.innerHTML = "Connecting to speaker, please wait..."; // Dịch
      } catch (e) {
  ...
  ws.onopen = function (data) {
    ...
    if (init_state) {
      ...
      if (h3_onopen)
        h3_onopen.innerHTML = "Speaker connected successfully, initializing..."; // Dịch
      setTimeout(function () {
        // ws_send(JSON.stringify({ type: 'shell', type_id: 'ping_r1service', shell: 'date & ping -w 1 r1service.wxfsq.com' }));
      ...
      if (unisound_init_timer == -1) {
        if (ver > 1825) {
          ...
          unisound_init_timer = setTimeout(function () {
            ...
            if (h3_timeout) {
              h3_timeout.innerHTML =
                "Unisound initialization timed out. Ensure new_Unisound v1.8+ is installed!"; // Dịch
            ...
            btn_enable.onclick = function () {
              ...
              ws_send(
                JSON.stringify({
                  type: "shell1",
                  shell: "/system/bin/pm unhide com.phicomm.speaker.device",
                })
              );
              setTimeout(function () {
                ws_send(
                  JSON.stringify({
                    type: "shell1",
                    shell:
                      "/system/bin/am start com.phicomm.speaker.device/.ui.MainActivity",
                  })
                );
                ws_send(
                  JSON.stringify({
                    type: "shell1",
                    shell:
                      "/system/bin/am startservice com.phicomm.speaker.player/.EchoService",
                  })
                );
                setTimeout(function () {
                  if (h3_timeout)
                    h3_timeout.innerHTML =
                      "Waiting for Unisound initialization... (Ensure new_Unisound v1.8+ is installed!)"; // Dịch
            ...
            btn_reboot_uni.onclick = function () {
              ...
              ws_send(
                JSON.stringify({
                  type: "shell1",
                  shell: "/system/bin/am force-stop com.phicomm.speaker.device",
                })
              );
              setTimeout(function () {
                ws_send(
            ...
            btn_reboot_spk.onclick = function () {
              ...
              ws_send(
                JSON.stringify({
                  type: "shell",
                  shell: "stop adbd&&start adbd&&adb reboot",
                })
              ); // This might not work without adb enabled
      ...
      setTimeout(function () {
        ...
        if (current_page) {
          ...
          if (title_reconnect == current_page.value) {
            // If page is already shown
            if (h3_reconnect)
              h3_reconnect.innerHTML = "R1 Speaker Control Panel" + dev_name; // Reset title
          } else {
            // If page was hidden, show it
            current_page.value = title_reconnect;
            switch_page(current_page); // Restore the page
          }
        } else {
          if (h3_reconnect)
            h3_reconnect.innerHTML = "R1 Speaker Control Panel" + dev_name; // Default title if page not found
        }
      }, 1000);
  ...
  ws.onclose = function (data) {
    ...
    if (data.code == 1006 || data.code == 1005) {
      // Treat 1005 (closed) similarly
      if (h3_onclose)
        h3_onclose.innerHTML =
          "Disconnected from speaker, attempting to reconnect in 1 second..."; // Dịch
      ...
      if (h3_onclose)
        h3_onclose.innerHTML =
          ...
          data.code +
          "), attempting to reconnect in 1 second..."; // Dịch
  ...
  ws.onerror = function (data) {
    ...
    if (h3_onerror)
      h3_onerror.innerHTML =
        "Connection error, attempting to reconnect in 3 seconds..."; // Dịch
  ...
  ws.onmessage = function (data) {
    if (typeof data.data == "string") {
      if (connect_init == true) {
        // First message after successful connect
        connect_init = false;
      ...
      try {
        ...
        // Sử dụng ErrorHandler để xử lý lỗi JSON parsing
        console.error("Failed to parse WebSocket message:", data.data);
        try {
          ErrorHandler.handle(e, ErrorHandler.LEVELS.ERROR, "JSON");
        } catch (err) {
          console.error("Error in ErrorHandler:", err);
        }
      }
    } else {
      // Binary data (likely screen capture)
      if (screen_div.style.display != "none") {
        var screenImg = document.getElementById("screen_img");
        if (screenImg) {
          // Check if element exists
          try {
            // Add try-catch for createObjectURL
...
function start_unisound() {
  ...
  ws_send(
    JSON.stringify({
      type: "shell1",
      shell: "/system/bin/am start com.phicomm.speaker.device/.ui.MainActivity",
    })
  );
}
  ...
  btn_sync_time.onclick = function () {
    ...
    ws_send(
      JSON.stringify({
        ...
        type_id: "set_date",
        shell:
          "settings put global ntp_server ntp1.aliyun.com & date " +
...
function onhide_login() {
  ...
  if (login_app == "qqmusic") {
    tips =
      "This login will use QQ Connect to log into your QQ Music account. Continue?"; // Dịch
  } else if (login_app == "netease") {
    tips =
      "This login will use QQ Connect to log into your Netease Cloud Music account. Continue?"; // Dịch
  } else if (login_app == "kuwo_qq") {
    tips =
      "This login will use QQ Connect to log into your Kuwo Music account. Continue?"; // Dịch
  }
  ...
  if (!confirm(tips)) {
    if (ws) {
      // Close WebSocket if user cancels
      ws.close();
    }
...
function load_qrcode() {
  ...
  var tmp_login_app =
    Storage.getItem("qrcode_app") == null
      ? login_app
      : Storage.getItem("qrcode_app");
  ...
  if (qrcode_state == 1 && qrcode_data) {
    ...
    qrcode.onload = function () {
      ...
      if (qrcode_msg.getElementsByTagName("h3").length > 0) {
        qrcode_msg.getElementsByTagName("h3")[0].innerText =
          "Please use Mobile QQ to scan the QR code to log in! (You can paste this page address in Mobile QQ and long-press the QR code image to scan!)"; // Dịch
      }
      start_update_qrstate(); // Start polling status
    };
    try {
      // Add try-catch for parsing stored data
...
function update_qrcode() {
  ...
  qrcode_load = false;
  qrcode_msg.innerHTML =
    "<h3>Loading QR code, please wait...<br>Tip: First time loading might be slow, please be patient!</h3><h3></h3>"; // Dịch
  qrcode.onload = function () {
    qrcode_load = true;
  ...
  var qr_timeout_timer = setTimeout(function () {
    // Use a separate timer for this timeout
    if (!qrcode_load) {
      ...
      var device_time_str =
        device_date != null
          ? set_time(Math.floor(device_date.getTime() / 1000))
          : "Unknown"; // Use Math.floor
      var sync_time_button_html =
        '<br><button class="btn" onclick="document.getElementById(\'sync_time_btn\').click()">Sync Speaker Time</button>'; // Add button directly
      qrcode_msg.innerHTML =
        '<h3>QR code loading timed out. Please click Refresh QR Code. (If it fails multiple times, try Reboot Unisound).<br><p id="device_time" style="display:inline">Speaker Time: ' +
        device_time_str +
        "</p>. If time is incorrect, click Sync Time then Refresh QR Code.</h3><h3></h3>"; // Dịch
    }
  ...
  if (ws && ws.readyState === WebSocket.OPEN) {
    ws_send(
      JSON.stringify({
        ...
        data: { type: "get_qrcode", login_param: login_param },
      })
    );
  } else {
    ...
    qrcode_msg.innerHTML =
      "<h3>Connecting to speaker before loading QR code...</h3><h3></h3>"; // Dịch
...
function start_update_qrstate() {
  if (qrcode_msg.getElementsByTagName("h3").length > 1) {
    qrcode_msg.getElementsByTagName("h3")[1].innerText =
      "Waiting for QR code status response..."; // Dịch
  }
  stop_update_qrstate(); // Clear previous timer
  qr_update_time = new Date().getTime();
  qr_last_update_time = -1;
  var update_qrcodef = function () {
    if (qr_update_time !== qr_last_update_time && qrcode.qrsig) {
      // Check if qrsig exists
...
function update_qrcode_data(data) {
  if (!data || !data.image || !data.cookies || !data.cookies.qrsig) {
    ...
    qrcode_msg.innerHTML =
      "<h3>Error loading QR code data. Please refresh.</h3><h3></h3>"; // Dịch
    return;
  }
...
function update_qrstate(data) {
  ...
  if (
    (qrcode_state_data.code != 66 && qrcode_state_data.code != 67) ||
    data.code == 0
  ) {
    // 66: QR valid, 67: Scanned
    if (qrcode_state_data.code != 0) {
      // Don't clear if login success (code 0)
      Storage.removeItem("qrcode_state");
      Storage.removeItem("qrcode_data");
      Storage.removeItem("qrcode_app");
  ...
  if (qrcode_state_data.code == "0") {
    ...
    if (qrcode_msg.getElementsByTagName("h3").length > 0) {
      qrcode_msg.getElementsByTagName("h3")[0].innerText =
        "Logged in with QQ: " + nickname + "(" + uin + ")"; // Dịch
    }
    msg = "Fetching user information, please wait..."; // Dịch
    qrcode.style =
      "margin: 10px auto;position: relative;border-radius: 100%;height:120px;width:120px;object-fit:cover;"; // Set style for avatar
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ...
        if (login_app == "qqmusic") {
          ...
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "login", qrcode_state: qrcode_state_data },
            })
          );
        } else if (login_app == "netease") {
          ...
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: {
                type: "login_netease_music",
                qrcode_state: qrcode_state_data,
              },
            })
          );
        } else if (login_app == "kuwo_qq") {
        ...
        if (qrcode_msg.getElementsByTagName("h3").length > 1) {
          qrcode_msg.getElementsByTagName("h3")[1].innerText =
            "Connection error, cannot complete login."; // Dịch
        }
      }
    }, 1000);
  } else {
...
function login_netease_music(data, type) {
  if (type == 0) {
    // Step 0: Got user info from Netease via QQ Connect redirect
    if (
      data.code == 1 &&
      data.data &&
      data.data.code == 200 &&
      ...
      if (qrcode && qrcode_msg.getElementsByTagName("h3").length > 1) {
        // Check if elements exist
        qrcode.src = data.data.profile.avatarUrl || "./pic/nopic.jpg"; // Use placeholder if no avatar
        qrcode_msg.getElementsByTagName("h3")[1].innerHTML =
          "Netease Music Login Successful!<br>User: " +
          nickname +
          "[" +
          userId +
          "]<br><div>Submitting login data...</div>"; // Dịch
      }
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            ...
            data: {
              type: "api",
              data: { type: "login_netease_music", data: data.data },
            },
          })
        );
      } else {
        ...
        if (qrcode_msg.getElementsByTagName("h3").length > 1)
          qrcode_msg.getElementsByTagName("h3")[1].innerText =
            "Connection error, cannot submit data."; // Dịch
      }
    } else {
    ...
    // Step 1: Speaker acknowledged the Netease profile data
    if (
      qrcode_msg.getElementsByTagName("h3").length > 1 &&
      qrcode_msg.getElementsByTagName("h3")[1].getElementsByTagName("div")
        .length > 0
    ) {
      qrcode_msg
        .getElementsByTagName("h3")[1]
        .getElementsByTagName("div")[0].innerHTML =
        "Data submitted, restarting Unisound..."; // Dịch
    }
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ...
          ws_send(
            JSON.stringify({
              ...
              arg1: 3,
              arg2: 0,
              obj: '{"type":"login_state","code":1,"login_state":"0"}',
            })
          ); // Simulate initial state after restart
          setTimeout(function () {
...
function login_kuwo_music(data, type) {
  if (type == 0) {
    // Step 0: Got user info from Kuwo via QQ Connect redirect
    if (
      data.code == 1 &&
      data.data &&
      data.data.result == "succ" &&
      data.data.userInfo
    ) {
      ...
      if (qrcode && qrcode_msg.getElementsByTagName("h3").length > 1) {
        ...
        qrcode_msg.getElementsByTagName("h3")[1].innerHTML =
          "Kuwo Music Login Successful!<br>User: " +
          nickname +
          "[" +
          userId +
          "]<br><div>Submitting login data...</div>"; // Dịch
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              ...
              data: {
                type: "api",
                data: { type: "login_kuwo_music", data: data.data },
              },
            })
          );
        } else {
    ...
    // Step 1: Speaker acknowledged Kuwo profile data
    if (data.code == 200) {
      // Check if API call was successful on speaker side
      if (
        qrcode_msg.getElementsByTagName("h3").length > 1 &&
        qrcode_msg.getElementsByTagName("h3")[1].getElementsByTagName("div")
          .length > 0
...
function login_state(data) {
  ...
  if (data.code == 1) {
    if (!init_state) {
      // Already initialized, login state changed (e.g., logged out elsewhere)
      location.reload(); // Reload to reflect the change
      return;
    }

    if (data.login_state == 0) {
      // State 0: Unisound initializing or not logged in
      if (unisound_init_timer != -1) {
            ...
            if (ws && ws.readyState === WebSocket.OPEN) {
              ws_send(
                JSON.stringify({
                  ...
                  arg1: 3,
                  arg2: 0,
                  obj: '{"type":"login_state","code":1,"login_state":"1"}',
                })
              );
            }
      ...
      if (unisound_init_timer1 == -1) {
        unisound_init_timer1 = setTimeout(function () {
          ...
          btn_reboot_uni.value = "Reboot Unisound"; // Dịch
          btn_reboot_uni.onclick = function () {
            /* ... (Reboot Unisound logic - same as above) ... */
          };
          btn_container.appendChild(btn_reboot_uni);
          ...
          btn_reboot_spk.value = "Reboot Speaker"; // Dịch
          btn_reboot_spk.onclick = function () {
            /* ... (Reboot Speaker logic - same as above) ... */
          };
          btn_container.appendChild(btn_reboot_spk);
      ...
      var syncTimeBtn =
        document.getElementById("sync_time_btn_fail") ||
        document.getElementById("sync_time_btn");
      ...
      // State -4: Authorization error (likely server-side)
      // Clear init timers
      if (unisound_init_timer != -1) clearTimeout(unisound_init_timer);
      unisound_init_timer = -1;
      if (unisound_init_timer1 != -1) clearTimeout(unisound_init_timer1);
      unisound_init_timer1 = -1;
      ...
      var ping_r1service_function = function () {
        ...
        var device_time_str =
          device_date != null
            ...
            : "Unknown"; // Dịch
        if (h3_auth_err)
          h3_auth_err.innerHTML =
            (data.login_msg || "Authorization Error") +
            '<br><p id="device_time" style="display:inline">Speaker Time: ' +
            device_time_str +
            "</p><br>Test Ping Auth Server: " +
            msg; // Dịch
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "shell",
              type_id: "ping_r1service",
              shell: "date & ping -w 1 r1service.wxfsq.com",
            })
          );
        }
      };
      ...
      var h3_parent = document.getElementsByTagName("h3")[0]?.parentNode;
      if (h3_parent && !document.getElementById("sync_time_btn_auth")) {
        // Use a specific ID
      ...
      if (data.login_msg && data.login_msg.includes("授权")) {
        // Check for keyword '授权' (Authorization)
        var h3_parent = document.getElementsByTagName("h3")[0]?.parentNode;
      ...
      alert(
        "Login State Error: " +
          (data.login_msg || "Unknown error") +
          " (State: " +
          data.login_state +
          ")"
      ); // Dịch
      if (!init_state) {
        // If already initialized, reload on error
        location.reload();
        return;
      }
...
function get_uin(uin) {
  ...
  uin = uin.substring(1); // Remove leading character (often 'o')
  for (var i = 0; i < uin.length; i++) {
    // Use var for broader compatibility
    if (uin[i] != "0") {
...
function Unisound(data) {
  ...
  if (parsed_unisound_data != null) {
    ...
    if (parsed_unisound_data.code == 1 || parsed_unisound_data.code == 2) {
      // Check success codes
      ...
      if (type == "get_qrcode") {
        ...
        type.startsWith("set_Time_reporting") ||
        type == "set_Whole_point_prompt" ||
        type == "set_Half_dot_prompt"
      ) {
        // Use startsWith
...
function message(data) {
  ...
  if (messageType === "sends") {
    ...
    if (data.code == 200 && data.data) {
      ...
      for (var i in list_sends) {
        if (list_sends.hasOwnProperty(i)) {
  ...
  } else if (messageType === "get_eq_config") {
    // Sound effects config update
    var parsedEqData = safeJsonParse(data.data, "get_eq_config");
    if (parsedEqData) {
      update_sound_effects(parsedEqData);
    }
  } else if (messageType == "login_state") {
    // Login state update (usually from Unisound)
    login_state(data.data); // Pass the inner data object
  } else if (messageType == "Unisound") {
    // Encapsulated message from Unisound
    if (unisound_init_timer != -1) clearTimeout(unisound_init_timer);
    unisound_init_timer = -1;
    if (unisound_init_timer1 != -1) clearTimeout(unisound_init_timer1);
    unisound_init_timer1 = -1;
    Unisound(data); // Process Unisound message
  } else if (messageType == "BT_Device") {
    // Bluetooth device list update
    update_bluetooth_data(data.data);
  } else if (messageType == "BT_enable") {
    // Bluetooth enabled confirmation
    if (btn_bluetooth_enable) btn_bluetooth_enable.wait = false;
  } else if (messageType == "BT_disable") {
    // Bluetooth disabled confirmation
    if (btn_bluetooth_enable) btn_bluetooth_enable.wait = false;
  } else if (messageType.startsWith("BT_")) {
    // Other Bluetooth commands (connect, disconnect, etc.)
    if (data.code != 200) {
    ...
    if (popup && popup.contains(bt_config_div)) {
      // Check if popup contains the div
      popup.onclose();
    }
  } else if (messageType == "max_vol") {
    // Max volume info
  ...
  } else if (messageType == "Auto_restart_device") {
    // Auto-reboot settings received
    if (data.code == 200) {
      create_Auto_restart_device(data.data);
    }
  } else if (
    messageType == "set_Auto_restart_device_open" ||
    messageType == "set_Auto_restart_device_time"
  ) {
    // Confirmation for auto-reboot setting change
    if (data.code == 200) {
      Auto_restart_device(); // Refresh the settings UI
    }
  } else if (messageType == "play_local_music") {
    // Result of playing local music command
  ...
  } else if (messageType == "reboot_echo" && data.type_id != "switch_player") {
    ...
    data.type_id == "switch_player"
  ) {
    // Player switch result
    if (data.code == 200) {
      var switchBtn = document.getElementById("switch_player"); // Get button element
      if (switchBtn) {
        // Check if button exists
        if (messageType == "reboot_echo") {
          // Confirmation after reboot for switch
          var player_name =
            switchBtn.getAttribute("PlayerType") == 2
              ? "ExoPlayer"
              : "MediaPlayer";
        ...
        ws_send(
          JSON.stringify({ type: "reboot_echo", type_id: "switch_player" })
        );
      }
    } else {
    ...
    // Other message types (mostly shell command results or confirmations)
    ...
    if (data.type == "shell" && type_id == "query") {
      // Old system info query
      hide_alert = true;
      set_systeminfo(data.data);
    } else if (
      data.type == "shell" &&
      type_id == "useless_services_detection"
    ) {
      // Useless services list
      hide_alert = true;
      useless_services_detection(data.data);
    } else if (data.type == "shell" && type_id == "hide_useless_services") {
      // Confirmation for hiding services
      hide_alert = true;
          ...
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "shell",
                type_id: "useless_services_detection",
                shell: "/system/bin/pm list packages",
              })
            );
          }
        }, 2000);
      }
    } else if (data.type == "shell" && type_id == "get_hostname") {
      // Hostname/IP result
      hide_alert = true;
      if (init_state || init_state1) {
      ...
      if (data.data) {
        try {
          ...
          console.log("Kết quả lệnh shell:", data.data);

          // Tách kết quả lệnh shell
          var shellOutput = data.data.trim();

          // Xử lý kết quả lệnh shell
          // console.log("Xử lý kết quả lệnh shell:", shellOutput);

          // Tách các dòng
          var lines = shellOutput.split("\r\n");

          // Tìm dòng chứa Phicomm_R1 trong kết quả (hostname)
          var foundValidHostname = false;
          for (var i = 0; i < lines.length; i++) {
            if (lines[i].includes("Phicomm_R1")) {
              shellOutput = lines[i].trim();
              // console.log("Tìm thấy hostname hợp lệ:", shellOutput);
              foundValidHostname = true;
              break;
            }
          }

          // Nếu không tìm thấy hostname hợp lệ, sử dụng giá trị mặc định
          if (!foundValidHostname) {
            shellOutput = "Phicomm_R1";
            // console.log("Không tìm thấy hostname hợp lệ, sử dụng mặc định:", shellOutput);
          }

          // Gán hostname
          hostname = shellOutput;
          // console.log("Hostname đã xử lý:", hostname);

          // Tìm địa chỉ IP từ kết quả netcfg
          for (var i = 0; i < lines.length; i++) {
            // Tìm dòng chứa wlan0 và UP (interface mạng đang hoạt động)
            if (lines[i].includes("wlan0") && lines[i].includes("UP")) {
              // Tách địa chỉ IP từ dòng
              var parts = lines[i].trim().split(/\s+/);
              for (var j = 0; j < parts.length; j++) {
                if (parts[j].includes("/")) {
                  // Địa chỉ IP có dạng 192.168.10.229/24
                  var ip = parts[j].split("/")[0];
                  if (ip && reg_ip1.test(ip)) {
                    local_ip = ip;
                    // console.log("Tìm thấy địa chỉ IP từ netcfg:", local_ip);
                    break;
                  }
                }
              }
          ...
          // Đã xử lý hostname và IP ở trên

          // Cập nhật thông tin thiết bị với IP đã tìm thấy
          if (hostname != "" && local_ip) {
            update_device_list({
              ...
              device_sid: "",
              device_msid: connect_id || "",
            });

            // Cập nhật giao diện người dùng với IP mới
            update_StatusBar();
          }

          if (hostname != "") {
            // Use local_ip if found, otherwise original ip might be the hostname itself
            var ip_to_store = local_ip ? local_ip : (ip && typeof ip === 'string' ? ip.split(":")[0] : ""); // Get IP part only
            update_device_list({
              hostname: hostname,
              ip: ip_to_store,
              dev_name: info.device_name,
            ...
            TimerManager.clear("update_background"); // Clear previous background timer
            TimerManager.set(
              "update_background",
              function () {
                // Update background after a delay
            ...
            // Tạo định danh ngắn từ hostname, đảm bảo an toàn khi hostname rỗng hoặc quá ngắn
            if (hostname && typeof hostname === 'string' && hostname.length > 0) {
              // Sử dụng substring thay vì substr (đã bị loại bỏ)
              if (hostname.length >= 4) {
                // Lấy 4 ký tự cuối cùng
                dev_name = "[" + hostname.substring(hostname.length - 4) + "]";
                // console.log("Lấy 4 ký tự cuối của hostname:", hostname, "-> dev_name:", dev_name);
              } else {
                // Nếu hostname ngắn hơn 4 ký tự, sử dụng toàn bộ hostname
                dev_name = "[" + hostname + "]";
                // console.log("Hostname ngắn hơn 4 ký tự, sử dụng toàn bộ:", hostname, "-> dev_name:", dev_name);
              }
            } else {
              // Sử dụng giá trị mặc định nếu hostname không hợp lệ
              dev_name = "[R1]";
              // console.log("Hostname không hợp lệ, sử dụng mặc định [R1]");
            }
          }
          // Cập nhật tiêu đề trang
          // Kiểm tra xem dev_name có đúng định dạng và khác với tiêu đề hiện tại
          if (
            dev_name &&
            !document.title.endsWith(dev_name) &&
            !document.title.includes("Fetching")
          ) {
            // Tránh cập nhật nếu đang tải
            if (document.title.endsWith("]")) {
              // Tìm vị trí dấu [ cuối cùng để thay thế chính xác hơn
              var lastBracketIndex = document.title.lastIndexOf("[");
              if (lastBracketIndex !== -1) {
                document.title = document.title.substring(0, lastBracketIndex) + dev_name;
              } else {
                // Nếu không tìm thấy dấu [, thêm vào cuối
            ...
            if (
              h3_title &&
              !h3_title.innerHTML.includes("Connecting") &&
              !h3_title.innerHTML.includes("Initializing")
            ) {
              // Tránh ghi đè các thông báo trạng thái
              h3_title.innerHTML = document.title;
            }
          }
        } catch (e) {
          // console.error("Lỗi khi xử lý kết quả lệnh shell:", e);
          hostname = "Phicomm_R1"; // Sử dụng giá trị mặc định nếu có lỗi
        }
      }
    } else if (data.type == "shell" && type_id == "get_ip") {
      // Xử lý kết quả lệnh lấy địa chỉ IP
      hide_alert = true;
      if (data.data) {
        var lines = data.data.split("\r\n");
        if (lines.length > 0) {
          // Lấy dòng đầu tiên có địa chỉ IP hợp lệ
          for (var i = 0; i < lines.length; i++) {
            var ip = lines[i].trim();
            if (ip && reg_ip1.test(ip)) {
              local_ip = ip;
              // console.log("Tìm thấy địa chỉ IP:", local_ip);

              // Cập nhật thông tin thiết bị với IP mới
              if (hostname != "") {
                update_device_list({
                  hostname: hostname,
                  ip: local_ip,
    ...
    } else if (data.type == "shell" && type_id == "ps") {
      // Process list result
      hide_alert = true;
      ps_message(data.data);
    } else if (data.type == "shell" && type_id == "ping_r1service") {
      // Ping result
      hide_alert = true;
      ...
      if (data.code == 200) {
        ...
        if (data.data) {
          ...
          if (data.data.includes("icmp_seq=1")) {
    ...
    } else if (data.type == "shell" && type_id == "set_date") {
    ...
    } else if (data.type == "shell" && type_id == "reboot_xiaoaiservice") {
      // Xiaoai reboot part 1
      hide_alert = true;
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "shell",
            shell:
              "am broadcast -a android.intent.action.BOOT_COMPLETED -n com.xiaomi.xiaoailite/.ai.BootReceiver&am broadcast -a android.intent.action.BOOT_COMPLETED -n com.duoqin.ai/com.xiaofei.BootReceiver",
          })
        );
        alert("Xiaoai service restart command sent!"); // Dịch
      }
    } else if (data.type == "shell" && type_id == "activation_xiaoai") {
      // Xiaoai activation part 1
      hide_alert = true;
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "shell",
            shell:
              "am broadcast -a android.intent.action.BOOT_COMPLETED -n com.xiaomi.xiaoailite/.ai.BootReceiver&am broadcast -a android.intent.action.BOOT_COMPLETED -n com.xiaomi.xiaoailite/com.taobao.accs.EventReceiver",
          })
        );
    ...
    } else if (data.type == "shell" && type_id == "screen_shell") {
      // Handle shell command results from Screen view
      hide_alert = true;
      ...
      // Generic play confirmation (might be from index change)
      hide_alert = true;
    } else if (data.type == "send_message" && type_id == "dormancy") {
      // Enter/Exit sleep confirmation
      hide_alert = true;
    ...
    } else if (type_id == "modify_color") {
      // Color save confirmation
      hide_alert = true;
      alert("Saved!"); // Dịch
    } else if (type_id == "get_device_info") {
      // Batch device info result (part 1)
      hide_alert = true;
    ...
    if (type_id != null && !hide_alert) {
      ...
      if (data.code == 200) {
        ...
        if (
          type_id.startsWith("Play") ||
          type_id == "Unisound Favorites" ||
          type_id == "Personal Radio"
        ) {
          // Use startsWith
...
window.onclick = function (event) {
  if (event.target == popup) {
    // Check if the click target is the popup background itself
...
function index(data) {
  if (reload) {
    // If reload flag is set (e.g., after Unisound error)
    location.reload();
    return;
  }
  ...
  if (ver + 1 > 1835) {
    // Check if version supports the Unisound flag
  ...
  if (init_state) {
    // Still waiting for hostname/ip info
    ...
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(
        JSON.stringify({
          type: "shell",
          type_id: "get_hostname",
        //   shell: "getprop net.hostname | grep -v getprop",
          shell: "getprop net.hostname && netcfg",
        })
      );
    }
  ...
  // --- Build Main Page UI ---
  // console.log("Tiêu đề trang được cập nhật với dev_name:", dev_name);
  ...
  if ((ver > 1600 && u_ver > 1600) || (ver > 1600 && u_ver > 1700)) {
    // Check version compatibility for source selector
    addedSelector = true;
  ...
  if (ver + 1 > 1847) {
    ...
    btn_bluetooth_scan1.onclick = function () {
      ...
      if (this.ScanMode == 23 || this.ScanMode == 21) {
        // If currently discoverable
        targetMode = 20; // Turn off discoverability
        this.value = "Make Discoverable"; // Dịch
      } else {
        // If currently not discoverable
    ...
    bluetooth_list_div.style =
      "max-width:600px;margin: 10px auto;background-color: rgba(0, 0, 0, 0.7);border-radius:15px;";
    ...
    text_list_title.style =
      "color:rgba(0,160,255,1);font-size: 15px; margin-left: 10px;"; // Add margin
    ...
    div_list_title_container.onclick = function () {
      // Toggle visibility
    ...
    bluetooth_lists.style =
      "margin: 0px auto;max-height:500px;overflow-x:hidden;overflow-y:auto; display: none;"; // Start hidden
    ...
    bluetooth_list_table.setAttribute(
      "style",
      "width:100%;color:rgba(0,160,255,1);margin: 0px auto;"
    );
    ...
    text_paired_title.style =
      "color:rgba(0,160,255,1);font-size: 13px; margin-left: 15px;"; // Style title
  ...
  if (ver + 1 > 1825 || (ver < 1823 && ver > 1800)) {
    ...
    div_info_container.style =
      "max-width:600px;margin: 10px auto;background-color: rgba(0, 0, 0, 0.7);border-radius:15px; padding: 0 10px;"; // Add padding
    ...
    if (is_new_unisound && u_ver + 1 > 1822 && ver + 1 > 1825) {
      ...
      Main_Wakeup_Benchmark_div.style =
        "color:rgba(238, 0, 0, 1); margin-bottom: 10px;"; // Add margin
      ...
      div_low.style =
        "width:50px;display:inline-block;text-align:center; vertical-align: middle;"; // Align text
      ...
      Main_Wakeup_Benchmark.addEventListener("input", function () {
        ...
        Main_Wakeup_Benchmark_timer = setTimeout(() => {
          if (ws && ws.readyState === WebSocket.OPEN) {
            var type_to_send =
              u_ver + 1 > 1848
                ? "User_Wakeup_Benchmark"
                : "Main_Wakeup_Benchmark";
            ...
            ws_send(
              JSON.stringify({ type: "send_to_unisound", data: data_to_send })
            );
          }
    ...
    if (is_new_unisound && u_ver + 1 > 1822 && ver + 1 > 1828) {
          ...
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                ...
                data: {
                  type: "asrMaxDuration",
                  Duration: parseInt(asrMaxDuration.value) * 1000,
                },
              })
            );
          }
      ...
      div_asr_value.style =
        "width:50px;display:inline-block;text-align:center; vertical-align: middle;";
    ...
    if (is_new_unisound && u_ver + 1 > 1800 && ver + 1 > 1825) {
      ...
      btn_relogin_qq.onclick = function () {
        if (
          confirm(
            "Are you sure you want to re-login to QQ Music?\nPlease use the same QQ account used previously!"
          )
        ) {
          // Dịch
          login_app = "qqmusic";
      ...
      if (u_ver + 1 > 1844) {
        ...
        btn_relogin_kuwo.onclick = function () {
          if (confirm("Are you sure you want to re-login to Kuwo Music?")) {
            // Dịch
      ...
      btn_relogin_netease.onclick = function () {
        if (
          confirm("Are you sure you want to re-login to Netease Cloud Music?")
        ) {
          // Dịch
          login_app = "netease";
          hide_device_info();
    ...
    dormancy_btn.onclick = function () {
      ...
      setTimeout(function () {
        data1.disabled = false;
      }, 2000); // Prevent rapid clicks

      var confirm_msg = "Are you sure you want to " + this.value + "?"; // Dịch

      if (this.dormancy_state != -1) {
        // Only confirm if state is known
      ...
      } else if (this.dormancy_state == 0) {
        // Currently awake, sleep
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "send_message",
    ...
    if (u_ver + 1 > 1840) {
      ...
      Wakeup_set_btn.onclick = function () {
        ...
        var action_text =
          this.Wakeup_set_state == 0 ? "Enable Mic" : "Disable Mic"; // Dịch
        var confirm_msg =
          "Are you sure you want to " +
          action_text +
          "?\nTip: This is a temporary switch!"; // Dịch

        if (this.Wakeup_set_state != -1) {
          // Only confirm if state is known
          if (!confirm(confirm_msg)) {
            return;
          }
        ...
        if (this.Wakeup_set_state == 1) {
          ...
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "send_to_unisound",
                data: { type: "stop_wakeup" },
              })
            );
          }
        } else if (this.Wakeup_set_state == 0) {
          // Currently disabled, enable
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "send_to_unisound",
                data: { type: "enter_wakeup" },
              })
            );
          }
        }
      ...
      if (
        !confirm(
          "Are you sure you want to disable " +
            useless_services_list.length +
            " potentially useless services? This might affect functionality."
        )
      )
        return; // Dịch + Confirmation
      btn.disabled = true;
      btn.value = "Please wait..."; // Dịch
      btn.setAttribute("wait", new Date().getTime() + 30000); // 30 sec timeout
      var commands = useless_services_list.map(
        (service) => "/system/bin/pm hide " + service
      ); // Create hide commands
      if (ws && ws.readyState === WebSocket.OPEN) {
        // Send commands one by one or batched if supported
        if (ver + 1 > 1855) {
          // Assumes batch support in newer versions
          ws_send(
            JSON.stringify({
              type: "shell1",
              type_id: "hide_useless_services",
              shells: commands,
            })
          );
        } else {
    ...
    if (ver + 1 > 1835) {
      // Enable/Disable Unisound Button
      ...
      btn_toggle_unisound.value = is_unisound
        ? "Disable Unisound"
        : "Enable Unisound"; // Dịch
          ...
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "shell1",
                shell:
                  "/system/bin/pm " + command + " com.phicomm.speaker.device",
              })
            );
    ...
    if (is_unisound) {
      ...
      btn_clear_unisound.onclick = function () {
        ...
        if (
          ...
          confirm("Really clear Unisound data? This cannot be undone!")
        ) {
          // Dịch double confirm
          var btn = this; // Use 'this'
          btn.disabled = true;
          ...
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "shell1",
                shell: "/system/bin/pm clear com.phicomm.speaker.device",
              })
            );
            setTimeout(function () {
              ws_send(
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: {
                type: "Set_Bluetooth_prompt_tone",
      ...
      Submit_Play_Record_btn.onclick = function () {
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "Submit_Play_Record", enable: enable_action },
            })
          );
          // Refresh info
          setTimeout(() => {
    ...
    if (is_new_unisound && u_ver + 1 > 1820 && ver + 1 > 1815) {
      ...
      btn_clear_memo.onclick = function () {
        if (confirm("Are you sure you want to clear all alarms/reminders?")) {
          // Dịch
          var btn = this; // Use 'this'
          btn.disabled = true;
          btn.value = "Please wait..."; // Dịch
          ...
          var command_data =
            command_type === "del_memo" ? { data: memo_list } : {}; // Include list for older version
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "send_to_unisound",
                data: { type: command_type, ...command_data },
              })
            );
          } else {
            alert("Connection error."); // Dịch
        ...
        if (
          confirm(
            "Are you sure you want to switch to " +
              targetName +
              "? The EchoService will restart."
          )
        ) {
          // Dịch
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({ type: "switch_player", player: targetPlayer })
            );
          } else {
            alert("Connection error."); // Dịch
          }
  ...
  if (ver > 1821) {
    ...
    checkbox_eq.onclick = function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({ type: "set_eq_enable", enable: this.checked })
        );
    ...
    checkbox_bass.onclick = function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({ type: "set_bass_enable", enable: this.checked })
        );
        setTimeout(() => {
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(JSON.stringify({ type: "get_eq_config" }));
    ...
    checkbox_loudness.onclick = function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({ type: "set_loudness_enable", enable: this.checked })
        );
        setTimeout(() => {
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(JSON.stringify({ type: "get_eq_config" }));
  ...
  if (ver > 1000) {
    ...
    img_screen.style =
      "max-width:100%; height: auto; border: 1px solid grey; background-color: #eee; min-height: 100px; display:block; margin: 0 auto;"; // Add some styling
      ...
      switch (event.type) {
        case "touchstart":
          ...
          long_press_timer = setTimeout(function () {
            ...
            ); // Simulate long press with short swipe
          }, 500); // 500ms for long press
          break;
        case "touchend":
          clearTimeout(long_press_timer); // Clear timer
          if (long_press_timer === -1) {
            // If long press already fired, do nothing more
            startx = -1;
            starty = -1; // Reset coords
            return;
          }
          ...
          if (distance > 10) {
            ...
            console.log(
              "Tap detected (or very short swipe) at:",
              targetX,
              targetY
            );
          }
          startx = -1;
          starty = -1; // Reset start coords
          break;
        case "touchmove":
          // Clear long press timer if finger moves significantly
          var move_dx = targetX - startx;
          var move_dy = targetY - starty;
          if (Math.sqrt(move_dx * move_dx + move_dy * move_dy) > 5) {
            // Movement threshold
    ...
    img_screen.onwheel = function (event) {
      // Use 'onwheel' standard event
      if (!ws || ws.readyState !== WebSocket.OPEN) return;
      ...
      if (now - mousewheel_interval > 200) {
        // Min 200ms interval
    ...
    for (var i = 0; i < key_controls.length; i++) {
      ...
      if (key_controls[i][1] == -1 && key_controls[i][2] == "input") {
        // Input Text Button
        ...
        btn_key.onclick = function () {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              // Re-enable button and restart screen
              btn.disabled = false;
              start_screen();
            }, 500);
            ...
            if (inputText != null && inputText !== "") {
              ...
              var input_function = function () {
                ...
                for (var i = 0; i < 5 && inputs.length > 0; i++) {
                  // Send up to 5 chars at a time
                  text_chunk += inputs.shift();
                }
                if (text_chunk !== "") {
                  send_input(
                    "text '" + text_chunk.replace(/'/g, "'\\''") + "'"
                  ); // Send escaped text
        ...
        // Other Key Event Buttons (Back, Delete)
    ...
    resultText.style =
      "width: 90%; height: 150px; padding: 5px; margin-top: 5px; background-color: rgba(0, 0, 0, 0.7); color: rgba(0, 160, 255, 1);";
  ...
  music_pic.style =
    "display: block;margin: 0px auto;position: relative;width: 183px;height: 183px;border: 6px solid rgba(0, 0, 0, 0.1);overflow: hidden;border-radius: 100%;-webkit-animation: img 30s linear infinite;animation: img 30s linear infinite;animation-play-state:paused;";
  ...
  music_lrc.style =
    "display: none; width: 100%; height: 195px; margin-top: 10px;"; // Start hidden, add margin
  musics_div.appendChild(music_lrc);

  // Double-click actions for cover/lyrics toggle
  music_pic.ondblclick = function () {
    if (music_info != null) {
      // Update title based on current music
  ...
  if (ver > 1827) {
    // Add listeners only if supported
    music_time.addEventListener("mousedown", function () {
      time_lock = true;
    }); // Lock updates on drag start
    music_time.addEventListener("touchstart", function () {
      time_lock = true;
    }); // Lock for touch
    ...
    music_time.addEventListener("touchend", function () {
      // Handle touch release same as mouseup
      setTimeout(() => {
        time_lock = false;
      }, 600);
      if (ws && ws.readyState === WebSocket.OPEN) {
  ...
  for (var i = 0; i < quality_options.length; i++) {
    ...
    if (data && option.value == data.ExoPlayer_Quality) {
      // Check initial data if available
      option.selected = true;
    }
  ...
  if (data && data.Support_Flac != true) {
    if (switch_quality.options.length > 2) {
      // Check if Hi-Res/Lossless options exist
  ...
  var controls2 = [];
  if (u_ver + 1 > 1700) {
    // Favorite buttons require higher Unisound version
  ...
  for (var i = 0; i < controls2.length; i++) {
    ...
    if (controls2[i][1] == "playmode") {
      ...
      var playmode_options = [
        ["Shuffle", 1],
        ["Sequence", 2],
        ["Repeat One", 3],
      ]; // Dịch modes
      var current_playmode = playmode_options[0]; // Default to Shuffle
      if (data && data.play_mode) {
        // Check if initial data has play_mode
      ...
      btn.onclick = function () {
        ...
        var nextModeIndex =
          (playmode_options.findIndex((m) => m[1] === currentMode) + 1) %
          playmode_options.length; // Cycle through modes
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({ type: "set_play_mode", mode: nextPlaymode[1] })
          );
  ...
  btn_cover_bg.value = Cover_background_open
    ? "Disable Cover Background"
    : "Enable Cover Background"; // Dịch text based on state
  btn_cover_bg.onclick = function () {
    ...
    if (Cover_background_open) {
      ...
      msg =
        "Are you sure you want to enable the cover background?\nTip: Enabling this might cause page lag!"; // Dịch
    }
    if (!confirm(msg)) {
      return;
    }
  ...
  text_vol_label.addEventListener("click", function () {
    // Click label to enable slider
    vols.style.pointerEvents = "auto";
    clearTimeout(vols_disabled_timer);
    vols_disabled_timer = setTimeout(function () {
      vols.style.pointerEvents = "none";
    }, 3000); // Disable after 3s
  });
  var div_vol_label = document.createElement("div");
  div_vol_label.style =
    "min-width:50px; display:inline-block; vertical-align: middle;"; // Align label
  ...
  vols.addEventListener("input", function () {
    ...
    vols.setTimeout = setTimeout(() => {
      mousedown = false;
    }, 600); // Reset flag after delay
    vols_disabled_timer = setTimeout(() => {
      vols.style.pointerEvents = "none";
    }, 3000); // Schedule disable

    vol_text.innerHTML = " " + this.value + "/" + this.max; // Update value display

    // Debounce sending volume change sử dụng TimerManager
    TimerManager.set(
      "volume_change",
      () => {
        if (ws && ws.readyState === WebSocket.OPEN) {
          ...
          // TimerManager.set('volume_update_info', () => {
          //     if (ws && ws.readyState === WebSocket.OPEN) ws_send(JSON.stringify({ type: 'get_info' }));
          // }, 150);
        }
      },
      50
    ); // Send after 50ms of no input
  });
  ...
  div_vol_value.style =
    "width:50px; display:inline-block; text-align: left; vertical-align: middle; margin-left: 5px;"; // Align value
  ...
  var page_options = [
    // Define pages and required versions
    ["Music", "music", 1000],
    ["Screen", "screen", 1000],
  ...
  div_list.style =
    "max-width:600px;display:none;margin: 10px auto;background-color: rgba(0, 0, 0, 0.7);border-radius:15px;"; // Hide initially
  ...
  text_playlist_title.style =
    "color:rgba(0,160,255,1);font-size: 15px; margin-left: 10px;";
  ...
  div_playlist_title_container.onclick = function () {
    // Toggle visibility
    ...
    // Kiểm tra xem list_content có tồn tại không
    if (!list_content) {
      console.error("playlist_content element not found");
      return;
    }

    // Kiểm tra trạng thái hiển thị hiện tại
    var isHidden = list_content.style.display === "none";

    // Ghi log để debug
    console.log("Toggle playlist visibility. Current state:", isHidden ? "hidden" : "visible");

    if (isHidden) {
      // Hiển thị danh sách
      if (list_occupancy) list_occupancy.style.display = "none";
      list_content.style.display = "block";
      if (list_ico) list_ico.innerHTML = "	▲"; // Expanded icon
      Storage.setItem(hostname + "_music_list_hide", 0); // Save state: visible

      // Scroll to current song when expanding
      if (List && List.playIndex > -1 && list && list.rows && list.rows.length > List.playIndex) {
        // Check if List and row exist
      ...
      // Nếu danh sách trống, yêu cầu cập nhật
      if (list && (!list.rows || list.rows.length === 0)) {
        console.log("Playlist is empty, requesting update");
        if (ws && ws.readyState === WebSocket.OPEN) {
      ...
      if (list_ico) list_ico.innerHTML = "	▼"; // Collapsed icon
  ...
  lists.style =
    "margin: 1px auto;max-height:500px;overflow-x:hidden;overflow-y:auto; display: block;"; // Start visible (or 'none' if default collapsed)
  ...
  for (var i = 0; i < buttons.length; i++) {
    ...
    var version_ok =
      ver >= button_config.min_ver &&
      ver <= button_config.max_ver &&
      u_ver >= button_config.min_uver &&
      u_ver <= button_config.max_uver;

    // Check Unisound requirement
    var unisound_ok =
      !button_config.is_unisound_required ||
      button_config.is_unisound === is_unisound;
    ...
    if (version_ok && unisound_ok) {
      ...
      if (button_config.hide) {
        // Check hide flag from config
  ...
  if (ver_div) {
    ...
    var unisound_ver_str =
      is_new_unisound && u_ver > 1000
        ? u_ver.toString().split("").join(".")
        : "N/A"; // Handle Unisound version display
  ...
  if (navigator.userAgent.includes("Firefox")) {
    // Use includes()
    insertStyle(
      "input[type=range] {background:rgba(0,160,255,1);vertical-align:middle;height: 12px;}"
    );
  }
  ...
  if (typeof plus != "undefined") {
    try {
      // Add try-catch for PlusRuntime features
  ...
  if (last_page_id && last_page_id !== "index") {
    // Check if a specific page was saved
  ...
  if (ver + 1 > 1855) {
    ...
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(
        JSON.stringify({ type: "send_to_unisound", data: { type: "get_info" } })
      );
      if (is_new_unisound) {
        setTimeout(function () {
          if (ws && ws.readyState === WebSocket.OPEN) {
  ...
  window.onpopstate = () => {
    ...
    if (target_button) {
      ...
      if (target_button.value !== target_button.getAttribute("data")) {
        // If button shows 'Back to Home' it's active
      ...
      // Handle navigating back to index/IP input page
...
function update_unisound_info(data) {
  if (data.code == 1) {
    ...
    if (!is_new_unisound) {
      // Do nothing if it's not the new Unisound version
      return;
    }
    ...
    if (u_ver + 1 > 1849) {
      ...
      // Older version check (relies only on isIdle)
      if (is_idle) {
        dormancy_btn.value = "Exit Sleep"; // Dịch
        dormancy_btn.dormancy_state = 1; // State: asleep
    ...
    if (Submit_Play_Record_btn && u_ver + 1 > 1824) {
      // Check if button exists and version supports it
    ...
    if (Bluetooth_prompt_tone_btn && u_ver + 1 > 1825 && ver + 1 > 1841) {
      // Check element and versions
    ...
    if (u_ver + 1 > 1848) {
      // Use User_Wakeup_Benchmark for newer versions
      if (Unisound_info.Wakeup_Benchmark) {
        // Check if data exists
      ...
      // Use Main_Wakeup_Benchmark for older versions
      if (Unisound_info.Main_Wakeup_Benchmark) {
        // Check if data exists
    ...
    if (Unisound_info.asrMaxDuration) {
      // Check if data exists
    ...
    console.warn(
      "Received non-successful get_info response from Unisound:",
      data
    );
  }
}
...
function Main_Wakeup_Benchmark_info(data) {
  if (
    ...
    if (!mousedown)
      Main_Wakeup_Benchmark.value = isNaN(currentVal) ? 0 : currentVal; // Update only if not dragging
  }
}
...
function User_Wakeup_Benchmark_info(data) {
  if (
    ...
    var maxOffset =
      (Main_Wakeup_Benchmark.maxvalue / 100 -
        (isNaN(defaultBenchmark) ? 0 : defaultBenchmark)) *
      100;
...
function asrMaxDuration_info(data) {
  if (
    ...
    if (!mousedown)
      asrMaxDuration.value = isNaN(currentDuration) ? 2 : currentDuration; // Use default if NaN, update if not dragging
...
function dateFormat(date, format) {
  ...
  format = format.replace(/([yMdpHmsqS])+/g, function (match, p1) {
    ...
    if (v !== undefined) {
      if (match.length > 1) {
        v = "0" + v;
        // Sử dụng substring thay vì substr
      ...
      return yearStr.substring(yearStr.length - match.length);
    }
    return match;
  });
  return format;
...
function update_btn_state() {
  ...
  for (var i = 0; i < btn_states.length; i++) {
    ...
    try {
      ...
      if (
        btn_data.is_unisound !== undefined &&
        btn_data.is_unisound !== is_unisound
      )
        continue;
      ...
      if (Array.isArray(state_values[0])) {
        ...
        for (var j = 0; j < state_values.length; j++) {
          if (
            Array.isArray(state_values[j]) &&
            state_values[j].includes(value)
          ) {
            matched_index = j;
            break;
          }
      ...
      if (matched_index === -1) {
        matched_index = 0;
        console.warn(
          "Could not find matching state for button value:",
          value,
          "- using default state"
        );
      }
      ...
      if (
        btn_data.title &&
        Array.isArray(btn_data.title) &&
        btn_data.title.length > matched_index
      ) {
      ...
      if (
        btn_data.tips &&
        Array.isArray(btn_data.tips) &&
        btn_data.tips.length > matched_index
      ) {
      ...
      if (
        btn_data.succ &&
        Array.isArray(btn_data.succ) &&
        btn_data.succ.length > matched_index
      ) {
...
function insertStyle(cssText) {
  ...
  style.type = "text/css";
  try {
    // Use try-catch for older IE compatibility (though likely not needed now)
    if (style.styleSheet) {
      // IE
...
function switch_page(button_element) {
...
function onhide_index() {
  // Hiển thị các phần tử của trang chính
  document.title = "R1 Speaker Control Panel" + (dev_name || ""); // Đảm bảo dev_name không null
  h3.innerHTML = document.title;
  if (texts_div) texts_div.style.display = "block";
  if (btns_div) btns_div.style.display = "block";
  Restore_background(); // Khôi phục hình nền mặc định/người dùng khi quay lại trang chính
}
function hide_index() {
  // Hide index page elements
  if (texts_div) texts_div.style.display = "none";
  if (btns_div) btns_div.style.display = "none";
}

function onhide_music() {
  // Hiển thị các phần tử của trang nhạc
  start_title_scrolling(); // Bắt đầu hiệu ứng cuộn tiêu đề
  start_lrc(); // Bắt đầu cập nhật lời bài hát
  document.title = "R1 Speaker Music" + (dev_name || ""); // Đảm bảo dev_name không null
  set_h3(document.title);
  h3.onclick = function () {
    // Cho phép nhấp vào tiêu đề để hiển thị thông tin bài hát đầy đủ tạm thời
    title_display_time = new Date().getTime() + 2000;
    if (music_info) {
      var title = get_music_title(music_info);
      set_h3("Now Playing: " + title); // Đang phát
      document.title = (dev_name || "") + h3.innerHTML; // Đảm bảo dev_name không null
    }
  };

  // Hiển thị danh sách phát khi vào trang Music
  var list_ico_music = document.getElementById("list_ico");
  ...
  // Hiển thị danh sách phát thay vì ẩn đi
  if (list_content_music) list_content_music.style.display = "block";
  if (list_occupancy_music) list_occupancy_music.style.display = "none";
  if (list_ico_music) list_ico_music.innerHTML = "▲"; // Set icon to expanded
  Storage.setItem(hostname + "_music_list_hide", 0); // Save expanded state

  // Cập nhật số lượng bài hát trong danh sách phát
  var list_title = document.getElementById("list_title");
  if (list_title) {
    var playlistLength = 0;
    if (List && List.playList && Array.isArray(List.playList)) {
      playlistLength = List.playList.length;
  ...
  // Yêu cầu cập nhật danh sách phát từ server ngay lập tức
  if (ws && ws.readyState === WebSocket.OPEN) {
    console.log("Requesting playlist update on music page load");
    ws_send(JSON.stringify({ type: "list" }));
  }
  ...
  // Bắt đầu hiệu ứng xoay ảnh bìa bài hát
  if (music_pic) {
    // Thêm hiệu ứng xoay nếu chưa có
    if (!music_pic.style.animation) {
      music_pic.style.animation = "rotate 20s linear infinite";
      music_pic.style.webkitAnimation = "rotate 20s linear infinite";

      // Thêm keyframes nếu chưa có
      var styleSheet = document.styleSheets[0];
      var keyframesRule = "@keyframes rotate { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }";
      var webkitKeyframesRule = "@-webkit-keyframes rotate { from { -webkit-transform: rotate(0deg); } to { -webkit-transform: rotate(360deg); } }";

      // Kiểm tra xem keyframes đã tồn tại chưa
      var keyframesExists = false;
      for (var i = 0; i < styleSheet.cssRules.length; i++) {
        if (styleSheet.cssRules[i].type === CSSRule.KEYFRAMES_RULE &&
            styleSheet.cssRules[i].name === 'rotate') {
          keyframesExists = true;
          break;
        }
      }

      // Thêm keyframes nếu chưa tồn tại
      if (!keyframesExists) {
        try {
          styleSheet.insertRule(keyframesRule, styleSheet.cssRules.length);
          styleSheet.insertRule(webkitKeyframesRule, styleSheet.cssRules.length);
        } catch (e) {
          console.error("Không thể thêm keyframes:", e);
        }
      }
...
function hide_music() {
  // Hide music page elements
  stop_title_scrolling();
  stop_lrc();
  h3.onclick = null; // Remove title click handler

  // Dừng hiệu ứng xoay ảnh bìa bài hát
  if (music_pic) {
    music_pic.style.animationPlayState = "paused";
  }
...
/**
 * Bắt đầu hiệu ứng cuộn tiêu đề cho bài hát đang phát
 */
function start_title_scrolling() {
  stop_title_scrolling(); // Xóa interval trước đó
  // Cập nhật tiêu đề ngay lập tức nếu có thông tin bài hát
  if (music_info != null && musics_div.style.display === "block") {
    // Kiểm tra xem trang nhạc có đang hiển thị không
    var title = get_music_title(music_info);
    set_h3("Now Playing: " + title); // Đang phát
    music_title = title + "    "; // Thêm khoảng trắng để tạo hiệu ứng cuộn
  } else {
    music_title = ""; // Xóa tiêu đề nếu không có thông tin bài hát
  }

  var title_scrolling_func = function () {
    if (music_title == "" || musics_div.style.display !== "block") {
      // Dừng nếu không có tiêu đề hoặc trang bị ẩn
      stop_title_scrolling();
      return;
    }
    // Chỉ cuộn nếu tiêu đề cần cuộn (dài hơn chiều rộng hiển thị)
    // Cách đơn giản: chỉ cuộn nếu tiêu đề dài
    if (music_title.length > 30) {
      // Điều chỉnh ngưỡng khi cần
      music_title = music_title.substring(1) + music_title.substring(0, 1); // Xoay vòng tiêu đề
      set_h3("Now Playing: " + music_title); // Cập nhật hiển thị
      document.title = (dev_name || "") + h3.innerHTML; // Cập nhật tiêu đề trình duyệt, đảm bảo dev_name không null
    } else {
      // Nếu tiêu đề ngắn, chỉ hiển thị tĩnh và dừng cuộn
      set_h3("Now Playing: " + music_title.trim()); // Cắt bỏ khoảng trắng thừa
      document.title = (dev_name || "") + h3.innerHTML; // Đảm bảo dev_name không null
      stop_title_scrolling();
    }
  };
  // Chỉ bắt đầu interval nếu tiêu đề đủ dài
  if (music_title.length > 30) {
    title_scrolling_timer = setInterval(title_scrolling_func, 500); // Khoảng thời gian cuộn
  } else {
    // Hiển thị tiêu đề ngắn tĩnh
    set_h3("Now Playing: " + music_title.trim()); // Đang phát
    document.title = (dev_name || "") + h3.innerHTML; // Đảm bảo dev_name không null
  }
}
...
/**
 * --- Quản lý cập nhật lời bài hát ---
 */

/**
 * Bắt đầu cập nhật lời bài hát
 *
 * Hàm này thiết lập timer để cập nhật lời bài hát theo thời gian thực.
 * Hiển thị tiêu đề bài hát trong giây đầu tiên, sau đó chuyển sang hiển thị lời.
 */
function start_lrc() {
  // Hiển thị tiêu đề trong 1 giây đầu
  title_display_time = new Date().getTime() + 1000;

  // Dừng timer cũ nếu có
  stop_lrc();

  // Cập nhật ban đầu sau một khoảng thời gian ngắn
  TimerManager.set('lrc_initial_update', function () {
    if (lrc_timer != -1 || musics_div.style.display === "block") {
      update_lrc(true, true); // Cập nhật và cuộn đến vị trí hiện tại
    }
  }, 500);

  // Thiết lập timer định kỳ cập nhật lời
  lrc_timer = TimerManager.set('lrc_update', () => update_lrc(false), 100, true);
}

/**
 * Dừng cập nhật lời bài hát
 */
function stop_lrc() {
  TimerManager.clear('lrc_update');
  lrc_timer = -1;
}
...
/**
 * Hiển thị trang điều khiển màn hình
 */
function onhide_screen() {
  document.title = "R1 Speaker Screen" + (dev_name || ""); // Đảm bảo dev_name không null
  var screenImg = document.getElementById("screen_img");
  if (screenImg) screenImg.src = ""; // Xóa hình ảnh trước đó
  h3.innerHTML = document.title;
  if (screen_div) screen_div.style.display = "block";
  start_screen(); // Bắt đầu luồng chụp màn hình
}
...
/**
 * Hiển thị trang hiệu ứng âm thanh
 */
function onhide_sound_effects() {
  document.title = "R1 Speaker Sound Effects" + (dev_name || ""); // Đảm bảo dev_name không null
  h3.innerHTML = document.title;
  if (sound_effects_div) sound_effects_div.style.display = "block";
  start_sound_effects(); // Bắt đầu cập nhật cấu hình EQ
}
...
function start_sound_effects() {
  ...
  // Sử dụng TimerManager thay cho setInterval
  TimerManager.set(
    ...
    1000,
    true
  ); // Poll every second, recurring=true
}
function stop_sound_effects() {
  // Sử dụng TimerManager thay cho clearInterval
  TimerManager.clear("sound_effects_update");
...
function update_sound_effects(data) {
  ...
  if (bass_switch)
    bass_switch.checked = bass.sound_effects_bass_enable === true;
  if (loudness_switch)
    loudness_switch.checked = loudness.sound_effects_loudness_enable === true;
  ...
  for (var i = 0; i < bandList.length; i++) {
    ...
    if (!eqs_div_exists) {
      ...
      var band_name =
        hz_names[band_data.Frequency] || band_data.Frequency / 1000 + "Hz"; // Use name or frequency
      hz_label.innerHTML = band_name + ": "; // Add colon // Dịch :
      var div_label = document.createElement("div");
      div_label.style =
        "width:80px; display:inline-block; vertical-align: middle; text-align: right; margin-right: 5px;"; // Style label
      ...
      band_slider.addEventListener("input", function () {
        // Update on input (while dragging)
        var current_band_index = this.getAttribute("Band");
        var current_band_text = document.getElementById(
          "band_text_" + current_band_index
        );
        if (current_band_text)
          current_band_text.innerHTML = " " + this.value + " dB"; // Update text // Dịch dB
      });
      band_slider.addEventListener("change", function () {
        // Send command on change (after release)
        var current_band_index = this.getAttribute("Band");
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "set_eq_bandlevel",
              band: current_band_index,
              level: parseInt(this.value) * 100,
            })
          ); // Send level in millibels
      ...
      div_text.style =
        "width:50px; display:inline-block; vertical-align: middle; margin-left: 5px;"; // Style text container
  ...
  if (!bass_div_exists) {
    ...
    div_bass_label.style =
      "width:80px; display:inline-block; vertical-align: middle; text-align: right; margin-right: 5px;";
    ...
    bass_slider.addEventListener("input", function () {
      ...
      if (current_bass_text)
        current_bass_text.innerHTML = " " + this.value + "%"; // Update text
    });
    bass_slider.addEventListener("change", function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "set_bass_strength",
    ...
    div_bass_text_cont.style =
      "width:50px; display:inline-block; vertical-align: middle; margin-left: 5px;";
  ...
  if (!loudness_div_exists) {
    ...
    loudness_slider.addEventListener("input", function () {
      var current_loudness_text = document.getElementById(
        "loudness_text_value"
      );
      if (current_loudness_text)
        current_loudness_text.innerHTML =
          " " + (this.value / 100).toFixed(1) + " dB"; // Update text (1 decimal place) // Dịch dB
    });
    loudness_slider.addEventListener("change", function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "set_loudness_gain",
            gain: parseInt(this.value),
          })
        ); // Send millibels value
      }
    });
  ...
  if (!preset_div_exists && presetList.length > 0) {
    // Create if first time and presets exist
    ...
    presetList.forEach((preset_item) => {
      ...
      if (preset_item.Preset == -1) {
        // Hide 'Custom' option visually unless active
  ...
  } else if (preset_select) {
    // Update existing select list if needed
...
/**
 * --- Quản lý chụp màn hình từ loa ---
 */

/**
 * Bắt đầu chụp màn hình từ loa
 *
 * Hàm này gửi lệnh bắt đầu chụp màn hình và thiết lập timer để cập nhật ảnh định kỳ.
 * Khoảng thời gian cập nhật được điều chỉnh dựa trên phiên bản firmware.
 */
function start_screen() {
  // Gửi lệnh bắt đầu chụp màn hình
  if (ws && ws.readyState === WebSocket.OPEN) {
    var interval = ver + 1 > 1855 ? 10 : 60; // Điều chỉnh khoảng thời gian dựa trên phiên bản
    ws_send(JSON.stringify({ type: "start_screencap", interval: interval }));
  }

  // Thiết lập timer để yêu cầu cập nhật ảnh màn hình
  screen_timer = TimerManager.set('screen_capture', function () {
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(JSON.stringify({ type: "get_screencap" }));
    }
  }, 100, true); // Cập nhật mỗi 100ms, recurring=true

  // Thiết lập điều khiển bàn phím để điều hướng màn hình
  document.onkeydown = function (event) {
    if (!screen_div || screen_div.style.display === "none") return; // Chỉ hoạt động khi ở trang màn hình
    var handled = false;
...
/**
 * Dừng chụp màn hình từ loa
 *
 * Hàm này dừng timer cập nhật và gửi lệnh dừng chụp màn hình đến loa.
 * Đồng thời xóa các bộ lắng nghe sự kiện bàn phím.
 */
function stop_screen() {
  // Dừng timer cập nhật
  TimerManager.clear('screen_capture');
  screen_timer = -1;

  // Gửi lệnh dừng chụp màn hình
  if (ws && ws.readyState === WebSocket.OPEN) {
    ws_send(JSON.stringify({ type: "stop_screencap" }));
  }

  // Xóa bộ lắng nghe sự kiện bàn phím
...
/**
 * Hiển thị trang thông tin thiết bị
 */
function onhide_device_info() {
  document.title = "R1 Speaker Device Info" + (dev_name || ""); // Đảm bảo dev_name không null
  h3.innerHTML = document.title;
  if (device_info) device_info.style.display = "block";
  update_device_info(); // Bắt đầu cập nhật thông tin thiết bị
}
/**
 * Ẩn trang thông tin thiết bị
 *
 * Hàm này dừng cập nhật thông tin thiết bị và ẩn trang thông tin.
 */
function hide_device_info() {
  // Dừng timer cập nhật thông tin thiết bị
  TimerManager.clear('update_systeminfo');
...
/**
 * Hiển thị trang Bluetooth
 */
function onhide_bluetooth() {
  document.title = "R1 Speaker Bluetooth" + (dev_name || ""); // Đảm bảo dev_name không null
  h3.innerHTML = document.title;
  if (bluetooth_div) bluetooth_div.style.display = "block";
  update_bluetooth(); // Bắt đầu cập nhật thông tin Bluetooth
}
function hide_bluetooth() {
  // Reset button states when hiding page
  if (btn_bluetooth_scan) {
    btn_bluetooth_scan.disabled = true;
    btn_bluetooth_scan.value = "Scan for Devices";
  } // Dịch
  if (btn_bluetooth_scan1) {
    btn_bluetooth_scan1.disabled = true;
    btn_bluetooth_scan1.value = "Make Discoverable";
  } // Dịch
  if (btn_bluetooth_enable) {
    btn_bluetooth_enable.disabled = true;
    btn_bluetooth_enable.value = "Enable Bluetooth Adapter";
...
function update_bluetooth() {
  ...
  // Sử dụng TimerManager thay cho setInterval
  TimerManager.clear("bluetooth_update");
  TimerManager.set(
    "bluetooth_update",
    function () {
    ...
    2000,
    true
  ); // Update every 2 seconds, recurring=true
}
...
function update_bluetooth_data(data) {
  ...
  if (btn_bluetooth_scan) {
    ...
    btn_bluetooth_scan.value = data.Scanning
      ? "Scanning..."
      : "Scan for Devices"; // Dịch
  }
    ...
    if (!data.Enabled) {
      ...
      if (
        ...
        if (info && info.Service_Normally_Open === true) {
          if (ws && ws.readyState === WebSocket.OPEN)
            ws_send(JSON.stringify({ type: "BT_setScanMode", mode: 21 })); // Connectable only
        }
      }
    }
  }
  ...
  if (btn_bluetooth_scan1) {
    ...
    btn_bluetooth_scan1.value =
      data.ScanMode == 23 || data.ScanMode == 21
        ? "Disable Discoverable"
        : "Make Discoverable"; // Dịch
  }
  ...
  function createDeviceListItem(deviceData, isPairedList) {
    ...
    if (
      A2dp_ConnectedDevices.includes(deviceData.Address) ||
      A2dpSink_ConnectedDevices.includes(deviceData.Address)
    ) {
      isConnected = true;
    ...
    var container = isPairedList
      ? bluetooth_pairing_devices
      : bluetooth_scan_devices;
    if (container) {
      if (container.hasChildNodes()) {
        // Add separator before adding new item (except first)
  ...
  if (pairingTitle)
    pairingTitle.innerHTML = "Paired Devices [" + paired_count + "]"; // Dịch
  ...
  Scan_Devices.forEach((device) => {
    if (
      !bonded_addresses[device.Address] &&
      !displayed_scan_addresses[device.Address]
    ) {
      // Only show if not bonded and not already shown
      var classInfo = processBluetoothClass(device.BluetoothClass);
      device.DeviceType = classInfo.DeviceType;
      device.A2dp = classInfo.A2dp;
      device.A2dpSink = classInfo.A2dpSink;
  ...
  if (scanTitle)
    scanTitle.innerHTML = "Scanned Devices [" + scanned_count + "]"; // Dịch
...
function processBluetoothClass(cod) {
  if (isNaN(cod))
    return { DeviceType: "UNKNOWN", A2dp: false, A2dpSink: false };
  ...
  var isA2dpSink =
    (MajorServiceClass & 0x40000) !== 0 || (MajorServiceClass & 0x100000) !== 0; // Bit 18 or 20 (Capture)
...
function create_bluetooth_device_config(tr_element) {
  ...
  config_container.style =
    "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:300px; max-width: 90%;"; // Adjust width
  ...
  title_div.style =
    "background-color: rgba(0,160,255,1);border-radius:15px 15px 0 0; padding: 10px; color: #ffffff; text-align: center;"; // Add padding
  ...
  title_h3.innerHTML =
    get_bluetooth_title(data) +
    '<br><span style="font-size: 12px;">MAC: ' +
    data.Address +
    "</span>"; // Use span for MAC
  title_div.appendChild(title_h3);

  // Options Area
  var option_div = document.createElement("div");
  option_div.style =
    "background-color: #ffffff;border-radius:0 0 15px 15px; max-height:400px; overflow-y:auto;"; // Limit height
  ...
  function addOption(
    ...
    if (option_div.hasChildNodes()) {
      // Add separator before new option (except first)
      var hr = document.createElement("hr");
  ...
  if (isConnected) {
    addOption("Disconnect Device", function () {
      // Dịch
      var disconnectType = data.A2dpConnect
        ? "BT_Disconnect_A2dp_Device"
        : "BT_Disconnect_A2dpSink_Device";
      if (ws && ws.readyState === WebSocket.OPEN) {
    ...
    if (data.BondState === 12) {
      ...
      if (canConnectA2DPSink) {
        addOption("Connect (Play audio from this device)", function () {
          // Dịch
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "BT_Connect_A2dpSink_Device",
                mac: data.Address,
              })
            );
            TimerManager.set(
      ...
      if (canConnectA2DP && ver >= 1875) {
        // Check version for speaker-as-source support
        addOption("Connect (Send audio to this device)", function () {
          // Dịch
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({
                type: "BT_Connect_A2dp_Device",
                mac: data.Address,
              })
            );
            TimerManager.set(
      ...
      // Not bonded, show Pair option
      // Check if pairing is possible (basic check - might need profile check too)
      if (canConnectA2DP || canConnectA2DPSink) {
        addOption("Pair with Device", function () {
          // Dịch
          if (ws && ws.readyState === WebSocket.OPEN) {
            ws_send(
              JSON.stringify({ type: "BT_createBond", mac: data.Address })
            );
  ...
  if (data.BondState === 12) {
    addOption("Unpair Device", function () {
      // Dịch
...
function get_bluetooth_title(deviceData) {
  ...
  const names = {
    // Icons or prefixes for device types
    COMPUTER: "💻 ",
    PHONE: "📱 ",
    AUDIO_VIDEO: "🎧 ",
...
function load_device_info() {
  ...
  if (api_info_data.code == 200) {
    ...
    var device_info_details =
      data.device_info.nameValuePairs || data.device_info; // Nested device info
    var user_info_details = data.user_info.nameValuePairs || data.user_info; // Nested user info

    // Update User Info Text
    user_info_text_elem.innerHTML =
      "User: " +
      (user_info_details.nick || "N/A") +
      "(" +
      (user_info_details.userid || "N/A") +
      ")"; // Dịch + Add fallback

    // QQ Music Status
    var qqmusic_login_state =
      user_info_details.qqmusic_login_state == 1
        ? "Logged In (" + (user_info_details.userid || "N/A") + ")"
        : "Not Logged In"; // Dịch
    ...
    if (u_ver + 1 > 1844) {
      ...
      var kuwo_login_state =
        user_info_details.kuwo_login_state == 1 && kuwo_uid != ""
          ? "Logged In (" + kuwo_uid + ")"
          : "Not Logged In"; // Dịch
    ...
    var netease_login_state =
      user_info_details.netease_login_state == 1 && netease_uid != ""
        ? "Logged In (" + netease_uid + ")"
        : "Not Logged In"; // Dịch
    user_info_text_elem.innerHTML +=
      "<br>Netease Music: " + netease_login_state; // Dịch

    // Last Login Time
    var login_time = user_info_details.login_time
      ? set_time(user_info_details.login_time)
      : "Unknown"; // Dịch
    user_info_text_elem.innerHTML += "<br>Last Login: " + login_time; // Dịch

    // Update Authorization Info Text
    sq_info_text_elem.innerHTML =
      "Public IP: " + (device_info_details.ip || "N/A"); // Dịch + Fallback
    sq_info_text_elem.innerHTML +=
      "<br>Device SN: " + (device_info_details.sn || "N/A"); // Dịch + Fallback
    sq_info_text_elem.innerHTML +=
      "<br>Device MAC: " + (device_info_details.mac || "N/A"); // Dịch + Fallback
    ...
    if (sq_type === 1 || sq_type === 2 || sq_type === 3) {
      // Check if any auth type exists
      if (current_time > expire_time && sq_type !== 3) {
        // Expired (not type 3)
        ...
        if (sq_type === 2) {
          ...
          // Type 1 (Normal) or 3 (Permanent/Text)
    ...
    // Handle API info error
    user_info_text_elem.innerHTML =
      "Error fetching info: " +
      (api_info_data.msg || "Unknown") +
      " (Code: " +
      api_info_data.code +
      ")"; // Dịch
...
function update_systeminfo() {
  ...
  if (ver + 1 > 1853) {
    // Newer versions support batch/specific info request
    const sends = [
      { type: "get_device_info", type_id: "get_device_info" },
      {
        type: "shell",
        type_id: "cpu_temp",
        shell: "cat /sys/class/hwmon/hwmon0/device/temp0_input",
      }, // Get CPU temp
    ];
    ws_send(
      JSON.stringify({ type: "sends", type_id: "device_info", list: sends })
    );
  } else {
    // Older versions use shell commands for basic info
    ws_send(
      JSON.stringify({
        type: "shell",
        type_id: "query",
        shell:
          "cat /proc/meminfo&&cat /proc/stat&&echo incremental:$(getprop ro.build.version.incremental)",
      })
    );
  }
}
...
function set_systeminfo1(deviceInfo, cpuTemp) {
  ...
  if (!state_info_text_elem || !deviceInfo) {
    // Check elements and data
    if (state_info_text_elem)
      state_info_text_elem.innerHTML = "Error loading system info."; // Dịch
    return;
  }
    ...
    for (var i = 0; i < deviceInfo.availableProcessors; i++) {
      ...
      if (cpuI) {
        ...
        cpuILines.forEach((line) => {
          var parts = line.split(":");
          if (parts.length === 2 && parts[0].trim() === "scaling_max_freq") {
            // Use scaling_max_freq for max potential
  ...
  if (info && info.Current_PlayerType) {
  ...
  if (cpuTemp) {
    ...
    if (tempLines.length > 0 && !isNaN(parseInt(tempLines[0]))) {
  ...
  infoHtml +=
    ...
    ") " +
    cpuUsage +
    cpuTempStr; // Dịch + Combine info
  var memAvailable =
    MemFree > -1 && Cached > -1 ? parseInt((MemFree + Cached) / 1024) : "N/A";
  var memTotal = MemTotal > -1 ? parseInt(MemTotal / 1024) : "N/A";
  infoHtml +=
    "<br>Available/Total Memory: " + memAvailable + "MB / " + memTotal + "MB"; // Dịch
  var uptime = deviceInfo.elapsedRealtime
    ? formatTimestamp(deviceInfo.elapsedRealtime)
    : "N/A"; // Format uptime
  infoHtml += "<br>System Uptime: " + uptime; // Dịch
  infoHtml +=
    "<br>Info Updated: " + set_time(Math.floor(new Date().getTime() / 1000)); // Dịch
...
function set_systeminfo(data) {
  ...
  // Parse Meminfo
  lines.forEach((line) => {
    if (MemTotal === -1 && line.startsWith("MemTotal:"))
      MemTotal = parseInt(line.split(":")[1]);
    if (MemFree === -1 && line.startsWith("MemFree:"))
      MemFree = parseInt(line.split(":")[1]);
    if (Cached === -1 && line.startsWith("Cached:"))
      Cached = parseInt(line.split(":")[1]);
    if (cpuData === null && line.startsWith("cpu "))
      cpuData = line.substring(5).split(" "); // Get first CPU line
    if (btime === null && line.startsWith("btime "))
      btime = parseInt(line.substring(6));
    if (incremental === "N/A" && line.startsWith("incremental:"))
      incremental = line.split(":")[1] || "N/A";
  });
  ...
  var memAvailable =
    MemFree > -1 && Cached > -1 && !isNaN(MemFree) && !isNaN(Cached)
      ? parseInt((MemFree + Cached) / 1024)
      : "N/A";
  var memTotal =
    MemTotal > -1 && !isNaN(MemTotal) ? parseInt(MemTotal / 1024) : "N/A";
  var uptime =
    btime && !isNaN(btime)
      ? formatTimestamp(new Date().getTime() - btime * 1000)
      : "N/A"; // Calculate uptime
...
function update_device_info1() {
  ...
  if (is_new_unisound && u_ver + 1 > 1820 && ver + 1 > 1815) {
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(
        JSON.stringify({ type: "send_to_unisound", data: { type: "get_memo" } })
      );
    }
  }
...
function useless_services_detection(data) {
  ...
  var potential_useless = [
    ...
    "com.android.externalstorage", // Be cautious with externalstorage
  ...
  if (btn_hide) {
    ...
    if (useless_services_list.length > 0) {
      ...
      if (new Date().getTime() > wait_time) {
        btn_hide.value =
          "Disable [" + useless_services_list.length + "] Useless Services"; // Dịch
...
function api(data, type_indicator) {
  // type_indicator: 0=no payload, 1=string payload, 2=object payload
  if (!data) return;
  ...
  if (data.login_state != 1 && data.login_msg) {
    ...
    if (user_info_text_elem) {
      user_info_text_elem.innerHTML =
        "API Error: " + data.login_msg + " (State: " + data.login_state + ")"; // Dịch
    }
  ...
  var payload;
  if (type_indicator === 1 && typeof data.data === "string") {
    // String payload, needs parsing
    try {
      payload = JSON.parse(data.data);
    } catch (e) {
      console.error("Failed to parse API string payload:", data.data, e);
      return;
    }
  } else if (type_indicator === 2 && typeof data.data === "object") {
    // Already an object
    payload = data.data;
  } else if (type_indicator === 0) {
    // No specific data payload, use the main data object
    payload = data;
  } else {
  ...
  if (api_type == "info") {
    // Detailed device/user info from API
    device_info_data.api_info = payload; // Store it
    load_device_info(); // Update the UI section
  } else if (api_type == "get_xiaoai_id") {
    // Xiaoai activation related
    ...
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(
        JSON.stringify({
          type: "shell",
          type_id: "activation_xiaoai",
          shell:
            "am broadcast -a android.intent.action.BOOT_COMPLETED -n com.xiaomi.xiaoailite/.ai.BootReceiver&am broadcast -a android.intent.action.BOOT_COMPLETED -n com.xiaomi.xiaoailite/com.taobao.accs.EventReceiver",
        })
      );
    }
  } else if (api_type == "login_netease_music") {
    // Netease login step 1 confirmation (from speaker API)
    login_netease_music(payload, 1);
  } else if (api_type == "login_kuwo_music") {
    // Kuwo login step 1 confirmation
    login_kuwo_music(payload, 1);
  } else if (api_type == "collect" || api_type == "cancel_collect") {
    // Favorite/Unfavorite confirmation
    alert(
      payload.msg || (api_type == "collect" ? "Favorited!" : "Unfavorited!")
    ); // Dịch fallbacks
    // Refresh music info to potentially update favorite status icon/button
    if (ws && ws.readyState === WebSocket.OPEN) {
      setTimeout(() => ws_send(JSON.stringify({ type: "get_info" })), 200);
    }
  } else if (api_type == "get_song_list") {
    // Playlist list received
...
function ps_message(data) {
  ...
  var white_list = [
    ...
    "com.phicomm.speaker.device", // Core Unisound
    ...
    "media.logd",
    "mediaserver",
    "audioserver", // Core Android media
    "lmkd",
    "servicemanager",
    "hwservicemanager",
    "gatekeeperd", // Core Android
  ...
  if (kill_commands.length > 0) {
    if (ws && ws.readyState === WebSocket.OPEN) {
      if (ver + 1 > 1855) {
        ...
        ws_send(
          JSON.stringify({
            type: ver + 1 > 1825 ? "shell1" : "shell",
            shell: kill_commands.join(" & "),
          })
        ); // Chain commands for older versions
      }
      if (btn_ps)
        btn_ps.value = "Cleaned [" + kill_commands.length + "] processes!"; // Dịch
    } else {
...
function formatTimestamp(timestamp, fullFormat = false) {
  ...
  if (fullFormat) {
    ...
    // Short format: show only relevant units
    var arr = [];
    if (days > 0) {
      arr.push(days + "d");
    } // Dịch "d"
    if (hours > 0 || (days > 0 && (minutes > 0 || seconds > 0))) {
      arr.push(hours + "h");
    } // Dịch "h", show if days>0 and lower units exist
    if (minutes > 0 || ((days > 0 || hours > 0) && seconds > 0)) {
      arr.push(minutes + "m");
    } // Dịch "m", show if higher units exist and seconds exist
    if (seconds >= 0) {
      arr.push(seconds + "s");
    } // Dịch "s", always show seconds if > 0 or if other units shown
...
/**
 * Bắt đầu cập nhật thông tin từ loa theo chu kỳ
 *
 * Hàm này thiết lập một timer định kỳ để gửi yêu cầu cập nhật thông tin đến loa
 * thông qua WebSocket. Đảm bảo rằng chỉ có một timer hoạt động tại một thời điểm.
 *
 * @param {Number} interval_ms - Khoảng thời gian giữa các lần cập nhật (ms), mặc định 1000ms
 */
function start_updateinfo(interval_ms = 1000) {
  // Đảm bảo khoảng thời gian hợp lệ
  if (!interval_ms || isNaN(interval_ms) || interval_ms < 500) {
    interval_ms = 1000; // Đặt giá trị tối thiểu là 1 giây
  }
  ...
  // Sử dụng TimerManager thay cho setInterval
  timer = TimerManager.set('update_info', function () {
    if (ws != null && ws.readyState === WebSocket.OPEN) {
      ws_send(JSON.stringify({ type: "get_info" }));
    }
  }, interval_ms, true); // recurring=true để hoạt động như setInterval
}

/**
 * Dừng cập nhật thông tin từ loa
 *
 * Hàm này dừng timer cập nhật thông tin và đặt lại trạng thái
 */
function stop_updateinfo() {
  // Sử dụng TimerManager thay cho clearInterval
  TimerManager.clear('update_info');
  timer = -1;
}
...
function update_TtsSpeaker(value) {
  ...
  send(
    "TTS Speaker changed successfully!",
    "Change TTS Speaker",
    "send_message",
    { what: 65536, arg1: 0, arg2: 2, obj: value }
  ); // Dịch messages
}

// Generic click handler for action buttons
function click(button_element) {
  // Renamed parameter
  ...
  var param;
  try {
    // Add try-catch for parsing JSON data
    param = JSON.parse(button_element.getAttribute("data"));
  } catch (e) {
    console.error(
      "Error parsing button data:",
      button_element.getAttribute("data"),
      e
    );
  ...
  if (param.type == 1 || param.type == 3) {
    ...
    if (button_element.value === "Set Ambient Light Color") {
      // Check by translated value // Dịch
      var colorInt = parseInt(input_value);
      if (
        isNaN(colorInt) ||
        (colorInt === 0 && !input_value.toLowerCase().includes("0x"))
      ) {
        input_value = ""; // Clear invalid input
        error_message =
          "Please enter a valid hexadecimal color value (e.g., 0xFF0000)!"; // Dịch
      } else {
    ...
    if (input_value === "" && param.type == 1) {
      ...
      switch (
        button_element.value // Use translated button values
      ) {
        case "Modify Unisound Wake Word": // Dịch
          current_val_info =
            "Current Unisound Wake Words:\n" +
            (info?.main_wakeup_word || []).concat("小讯小讯").join("\n") +
            "\n"; // Dịch
          break;
        case "Modify Device Name": // Dịch
          current_val_info = info?.device_name
            ? "Current Device Name: " + info.device_name + "\n"
            : ""; // Dịch
          break;
        case "Set Ambient Light Brightness": // Dịch
          current_val_info =
            info?.music_light_luma != null
              ? "Current Brightness: " + info.music_light_luma + "\n"
              : ""; // Dịch
          break;
        case "Set Color Gradient Speed": // Dịch
          current_val_info =
            info?.music_light_chroma != null
              ? "Current Gradient Speed: " + info.music_light_chroma + "\n"
              : ""; // Dịch
          break;
        case "Set Ambient Light Color": // Dịch (Handled above, but add current value info)
          if (info?.music_light_color != null) {
            var hex_color = info.music_light_color
              .toString(16)
              .toUpperCase()
              .padStart(6, "0");
        ...
        case "Modify Xiaoai Wake Word": // Dịch
          current_val_info =
            Unisound_info?.Wakeup_Xiaoai_Word?.length > 0
              ? "Current Xiaoai Wake Words:\n" +
      ...
      var text_area = document.getElementById("text");
      if (text_area)
        text_area.value = "[" + button_element.value + "]: " + error_message;
    ...
    if (input_keys.length > 1) {
      // Nested property like obj.iot_api
      ...
      for (var i = 0; i < input_keys.length - 1; i++) {
        ...
        if (typeof current_level[input_keys[i]] === "string") {
          try {
            current_level[input_keys[i]] = JSON.parse(
              current_level[input_keys[i]]
            );
          } catch (e) {
            console.error("Error parsing nested param:", input_keys[i]);
            current_level[input_keys[i]] = {};
          }
        } else if (
          typeof current_level[input_keys[i]] === "undefined" ||
          current_level[input_keys[i]] === null
        ) {
          current_level[input_keys[i]] = {};
        }
    ...
    } else if (input_keys.length === 1 && input_keys[0] !== "") {
      // Simple property
    ...
    if (button_element.value === "Execute Command") {
      // Dịch
      if (
        !confirm(
    ...
    } else if (button_element.value === "Execute Shell") {
      // Dịch
      if (
        !confirm(
    ...
    if (button_element.value !== "Execute Shell") {
      // Dịch
    ...
    if (param.title && param.title.length > 0) {
      ...
      if (current_state === -1) {
        for (var i = 0; i < param.title.length; i++) {
          if (
            button_text.includes(param.title[i]) ||
            param.title[i].includes(button_text)
          ) {
            current_state = i;
            break;
          }
      ...
      if (current_state === -1) {
        console.warn(
          "Could not find matching state for toggle button:",
          button_text
        );
        current_state =
          button_element.state_index !== undefined
            ? button_element.state_index
            : 0;
      }
      ...
      if (
        !(
          param.state &&
          param.state[0] === 0 &&
          param.state[1] === "info.music_light_mode"
        )
      ) {
      ...
      // Send the command
      send(
        param.succ ? param.succ[current_state] : "OK",
        action_tip,
        param.ws_type,
        payload_to_send
      );
    ...
    if (current_index === -1) {
      for (var i = 0; i < param.title.length; i++) {
        ...
        if (
          button_element.value.includes(param.title[i]) ||
    ...
    if (current_index === -1) {
      ...
      if (button_element.state_index !== undefined) {
        ...
        if (
          button_element.value.includes("Bluetooth") ||
    ...
    var action_tip = param.tips
      ? param.tips[current_index]
      : button_element.value; // Get tip or use button text
    ...
    // Send the command
    send(
      param.succ ? param.succ[current_index] : "OK",
      action_tip,
      param.ws_type,
      payload_to_send
    );
    ...
    switch (itemType) {
      ...
      case "open_net_config":
        if (
          !confirm(
            "Enter Network Configuration mode? Web control will disconnect."
          )
        )
          return; // Dịch
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({ type: "send_message", what: 262144, arg1: 1 })
          );
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "NetworkConfigOutputEvent", status: 1 },
            })
          );
        }
        alert(
          "Network config mode enabled!\nRedirecting to configuration page..."
        ); // Dịch
      ...
      case "upload_page":
        ...
        if (ip && ip !== "") {
          ...
          alert(
            "Speaker IP address not found. Please make sure you are connected to the speaker."
          );
      ...
      case "xiaoai_tonesettings":
        if (
          !confirm(
            "Open Xiaoai Tone Settings page? This might cause lag. Please reboot Xiaoai service after setting."
          )
        )
          return; // Dịch
        if (ws && ws.readyState === WebSocket.OPEN)
          ws_send(
            JSON.stringify({
              type: "shell1",
              shell:
                "am start -n com.xiaomi.xiaoailite/.presenter.activity.ToneSettingActivity",
            })
          );
      ...
      case "xiaoai_settings":
        if (
          !confirm(
            "Open Xiaoai Settings page? This might cause lag. Please reboot Xiaoai service after setting.\nRecommended to disable microphone before opening."
          )
        )
          return; // Dịch
        if (ws && ws.readyState === WebSocket.OPEN)
          ws_send(
            JSON.stringify({
              type: "shell",
              shell:
                "am start -n com.xiaomi.xiaoailite/.presenter.info.PersonalInfoActivity&am start -n com.duoqin.ai/.MainActivity",
            })
          );
        alert("Page opened, please check the Screen Control page!"); // Dịch
        break;
      case "reboot_xiaoaiservice":
        ...
        if (ws && ws.readyState === WebSocket.OPEN)
          ws_send(
            JSON.stringify({
              type: "shell",
              type_id: "reboot_xiaoaiservice",
              shell:
                "am force-stop com.xiaomi.xiaoailite&am force-stop com.duoqin.ai",
            })
          );
      ...
      case "activation_xiaoai":
        ...
        if (ws && ws.readyState === WebSocket.OPEN)
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "api", data: { type: "get_xiaoai_id" } },
            })
          );
        break;
      case "play_local_music":
        ...
        if (
          info &&
          info.Current_PlayerType == 2 &&
          info.Support_Flac !== true
        ) {
          // Check player type and FLAC support
          confirm_msg +=
      ...
      case "get_song_list":
        ...
        if (
          cached_list &&
          cached_list.data &&
          new Date().getTime() - cached_list.time < 600000 &&
          cached_list.music_source === (info ? info.music_source : null)
        ) {
            ...
            ws_send(
              JSON.stringify({
                ...
                data: {
                  ...
                  data: {
                    type: "get_song_list",
                    music_source: temp_song_list.music_source,
                  },
                },
              })
            );
    ...
    if (
      button_element.value === "Unisound Favorites" ||
      button_element.value === "Favorite Songs" ||
      button_element.value === "Personal Radio"
    ) {
      // Dịch comparison
...
function send(success_tip, type_id, ws_type, data_payload, callback = null) {
  try {
    ...
    // Xử lý đặc biệt cho các lệnh Unisound
    if (data_payload.what == 65536 && data_payload.arg2 == 1) {
      if (
        is_new_unisound &&
        u_ver + 1 > 1849 &&
        Unisound_info &&
        Unisound_info.DeviceStatus == 5
      ) {
        if (ws && ws.readyState === WebSocket.OPEN) {
          // Cập nhật trạng thái thiết bị trước khi gửi lệnh
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "UpdateDeviceStatus", status: 0 },
            })
          );

          // Sử dụng TimerManager thay cho setTimeout trực tiếp
          TimerManager.set(
            "send_after_status_update",
            () => {
              if (ws && ws.readyState === WebSocket.OPEN) {
    ...
    // Gửi dữ liệu nếu WebSocket đang mở
    if (ws && ws.readyState === WebSocket.OPEN) {
      ws_send(JSON.stringify(data_payload));
    } else {
      // Xử lý lỗi kết nối
      var text_area = document.getElementById("text");
      var error_msg =
        "[" + (type_id || ws_type) + "]: Connection error. Command not sent."; // Dịch
      if (text_area) text_area.value = error_msg;

      // Sử dụng ErrorHandler thay vì alert trực tiếp
      ErrorHandler.handle(error_msg, ErrorHandler.LEVELS.ERROR, "WebSocket");
    }
    ...
    ErrorHandler.handle(e, ErrorHandler.LEVELS.ERROR, "send");
...
function update_info(data) {
  try {
    ...
    $("input[type=range]").each((key, val) => {
      // Use 'each' and arrow function
    ...
    if (data.u_ver != null && u_ver != data.u_ver) {
      ...
      if (data.u_ver == 1000) {
        // Potentially reverted to old version?
        is_unisound_num[2]++; // Increment counter
        if (is_unisound_num[2] > 6) {
          // Reload if it happens repeatedly
          console.log(
            "Unisound version reverted unexpectedly. Reloading page."
          );
          location.reload();
          return;
        } else {
          console.warn(
            "Unisound version seems to have reverted. Keeping current u_ver:",
            u_ver
          );
          // Don't update u_ver immediately, wait for confirmation
        }
      } else {
        // Updated to a newer (or different non-1000) version
        if (u_ver == 1000) {
    ...
    if (ver + 1 > 1835) {
      ...
      if (current_is_unisound !== is_unisound) {
        // If status changed
      ...
      if (disable_unisound_btn) {
        disable_unisound_btn.value = is_unisound
          ? "Disable Unisound"
          : "Enable Unisound"; // Dịch
      }
    }
    ...
    if (vol_text && vol_text.innerHTML != vol_display)
      vol_text.innerHTML = vol_display; // Update text if changed

    // Update TTS Speaker Selector
    var tts_speaker_select = document.getElementById("tts_speaker");
    if (tts_speaker_select && tts_speaker_select.value !== data.ttsModelType) {
      ...
      if (!found)
        console.warn(
          "TTS Speaker value not found in select list:",
          data.ttsModelType
        );
    }
    ...
    if (ver > 1600 && u_ver > 1600) {
      ...
      if (
        music_source_select &&
        music_source_select.value !== data.music_source
      ) {
        ...
        if (!found)
          console.warn(
            "Music Source value not found in select list:",
            data.music_source
          );
      }
    }
    ...
    if (u_ver + 1 > 1700) {
      ...
      var btn_cancel_collect = document.getElementById(
        "music_btn_cancel_collect"
      );
      if (btn_collect && btn_cancel_collect) {
        // Check buttons exist
        var show_fav_buttons =
          data.music_info &&
          (data.music_info.ItemType == 0 || data.music_info.ItemType == 1); // Determine visibility based on item type
    ...
    if (musics_div.style.display == "none") {
      // Don't update music details if page not visible
      return;
    }
    ...
    if (data.play_type == 2) current_title = "Now Playing: DLNA Mode"; // Dịch
      ...
      current_title = "Now Playing: AirPlay Mode"; // Dịch
    ...
    if (data.play_type == 2 || data.play_type == 3) {
      ...
      // Music playback or Bluetooth
      if (prevBtn) prevBtn.disabled = false;
      if (nextBtn) nextBtn.disabled = false;
      if (playBtn) playBtn.disabled = false;
      if (playmodeBtn)
        playmodeBtn.style.display = data.play_type == 1 ? "" : "none"; // Show playmode only for internal playback
    }
    ...
    if (music_info != null) {
      ...
      if (ver + 1 > 1858) {
        // Newer state logic
        is_playing =
          data.play_state && music_info.state != 6 && music_info.state != 10; // Playing if state is true and not buffering/loading
      } else {
        // Older state logic
        is_playing =
          (data.play_state && music_info.state != 6) || // Playing and not buffering
          (music_info.state != 2 &&
            music_info.state != 3 &&
            music_info.state != 6 &&
            data.play_type != 4) || // Playing internal source (not paused/stopped/buffering)
          ((music_info.state == 1 || music_info.state == 2) &&
            data.play_type == 4); // Playing Bluetooth
      }
      ...
      if (playBtn) {
        // Check if button exists
        if (is_playing) {
          // Thêm hiệu ứng xoay cho ảnh bìa bài hát
          if (music_pic) {
            music_pic.style.webkitAnimationPlayState = "running";
            music_pic.style.animationPlayState = "running";
      ...
      if (data.play_type == 2) {
        // DLNA uses combined info as ID
        current_track_identifier = encodeURIComponent(
          (music_info.title || "") +
            "-" +
            (music_info.artist || "") +
            "-" +
      ...
      if (music_id !== current_track_identifier) {
        ...
        if (data.play_type == 2 && display_title !== "undefined-undefined")
          current_title = "[DLNA] " + display_title; // Dịch prefix
      ...
      if (
        ...
        music_info.position != null
      ) {
        // Check if position/duration exist
        ...
        if (pos > dur && dur > 0) {
          // Handle position exceeding duration
      ...
      if (title_display_time - new Date().getTime() > 0) {
        ...
        if (data.play_type == 2 && display_title_now !== "undefined-undefined")
          current_title = "[DLNA] " + display_title_now; // Dịch
        else if (data.play_type == 4)
          current_title =
            "[Bluetooth] " +
            (display_title_now !== "undefined-undefined"
              ? display_title_now
              : ""); // Dịch
      ...
      // No music info (stopped or playing non-info source like BT without metadata)
      if (music_id != null || (play_type != 0 && data.play_type == 0)) {
        ...
        info_time = [];
        music_id = null;
        // Hiển thị "Không có bài hát đang phát" thay vì "No lyrics available"
        lrcs = [[-1, "Không có bài hát đang phát"]];
      ...
      if (playBtn) {
        // Check button exists
        if (music_pic) music_pic.style.animationPlayState = "paused";
        playBtn.value = "Play"; // Dịch
        playBtn.setAttribute("data", "play");
    ...
    // Sử dụng ErrorHandler để xử lý lỗi trong quá trình cập nhật UI
    ErrorHandler.handle(e, ErrorHandler.LEVELS.ERROR, "update_info");
...
function update_music_info() {
  ...
  update_music_info_timer = setTimeout(() => {
    ...
    if (music_info && music_info.albumUrl && music_pic) {
      console.log("Đã tìm thấy albumUrl trong music_info:", music_info.albumUrl);
      // Cập nhật hình ảnh bìa album trực tiếp từ music_info
    ...
    if (music_id != null && music_id.toString().startsWith("local_")) {
      // Local file
      if (Current_MusicData == null && ver + 1 > 1865) return; // Need metadata for local files on newer versions
      post_data = {
        info: music_id,
        file: music_info.title,
        metadata: JSON.stringify(Current_MusicData?.MediaMetadata || null),
      }; // Safely access metadata

      // Hiển thị thông tin bài hát local
      console.log("Thông tin bài hát local:", {
        title: music_info.title,
        artist: music_info.artist,
      ...
      post_data = {
        type: "dlna",
        info: music_id,
        file: get_music_title(info.music_info),
      };

      // Hiển thị thông tin bài hát DLNA
      console.log("Thông tin bài hát DLNA:", {
        title: info.music_info?.title,
        artist: info.music_info?.artist,
        album: info.music_info?.album,
        albumUrl: info.music_info?.albumUrl
      });

    } else if (music_id != null) {
      // Standard online track
      post_data = {
        info: music_id,
        music_info: JSON.stringify(music_info || null),
      }; // Include basic info if available

      // Hiển thị thông tin bài hát online
      console.log("Thông tin bài hát online:", {
        id: music_id,
        title: music_info?.title,
        artist: music_info?.artist,
        album: music_info?.album,
    ...
    var initialSongTitle = music_info?.title || "Unknown Track";
    var initialSongArtist = music_info?.artist || "";
    var initialDisplayTitle = initialSongTitle + (initialSongArtist ? " - " + initialSongArtist : "");
    ...
    var success_callback = function (api_data) {
      ...
      if (api_data.code == 1) {
        ...
        if (music_id != fetched_info.id) {
          console.log(
            "API info received for outdated track:",
            fetched_info.id,
            "current:",
            music_id
          );
        ...
        console.log("Thông tin chi tiết từ API:", fetched_info);
        ...
        // Process Lyrics
        // Hiển thị tên bài hát khi không có lyrics
        var songTitle = fetched_info.name || music_info.title || "Unknown Track";
        var songArtist = fetched_info.artist || music_info.artist || "";
        var displayTitle = songTitle + (songArtist ? " - " + songArtist : "");

        // Đặt lyrics mặc định là tên bài hát
        lrcs = [[-1, displayTitle]];

        if (fetched_info.lrc && typeof fetched_info.lrc === "string" && fetched_info.lrc.trim() !== "") {
          console.log("Xử lý lyrics từ API:", fetched_info.lrc.substring(0, 100) + "...");

          var raw_lrc = fetched_info.lrc
            .replace(/\[/g, "\r\n[")
            .replace(/\r\n\r\n/g, "\r\n")
            .trim();
          ...
          lrc_lines.forEach((line) => {
            ...
            if (time_matches && lrc_text !== "") {
              ...
              parsed_lrcs.push([-1, lrc_text]); // Thêm các dòng không có timestamp
            }
          });

          if (parsed_lrcs.length > 0) {
            console.log("Đã phân tích được " + parsed_lrcs.length + " dòng lyrics");
            // Sắp xếp lyrics theo thời gian, giữ lại các dòng không có timestamp ở đầu
            var timestamped_lrcs = parsed_lrcs.filter(lrc => lrc[0] !== -1).sort((a, b) => a[0] - b[0]);
            var non_timestamped_lrcs = parsed_lrcs.filter(lrc => lrc[0] === -1);

            // Nếu có lyrics có timestamp, sử dụng cả hai loại
            if (timestamped_lrcs.length > 0) {
              lrcs = [...non_timestamped_lrcs, ...timestamped_lrcs];
            }
            // Nếu chỉ có lyrics không có timestamp, thêm tên bài hát vào đầu
            else if (non_timestamped_lrcs.length > 0) {
              lrcs = [[-1, displayTitle], ...non_timestamped_lrcs];
            }
            // Nếu không có lyrics nào, hiển thị tên bài hát
            else {
              lrcs = [[-1, displayTitle]];
            }
          } else {
            // Nếu không có lyrics có timestamp, vẫn hiển thị tên bài hát
            console.log("Không phân tích được lyrics, hiển thị tên bài hát");
            lrcs = [[-1, displayTitle]];
          }
        } else {
          console.log("Không có lyrics từ API, hiển thị tên bài hát");
        }
      } else {
        // API returned error code
        console.warn("Music API Error:", api_data.msg);

        // Hiển thị tên bài hát khi không có lyrics (lỗi API)
        var songTitle = music_info.title || "Unknown Track";
        var songArtist = music_info.artist || "";
        var displayTitle = songTitle + (songArtist ? " - " + songArtist : "");

        lrcs = [[-1, displayTitle]]; // Hiển thị tên bài hát thay vì thông báo lỗi

        // Sử dụng albumUrl từ music_info nếu có
        if (music_pic && music_info && music_info.albumUrl && music_info.albumUrl.trim() !== "") {
          console.log("API lỗi, sử dụng albumUrl từ music_info:", music_info.albumUrl);
          music_pic.src = music_info.albumUrl;
        }
      }
    ...
    // API Error Handler
    var error_callback = function (_, textStatus, errorThrown) {
      console.error("Music API Request Failed:", textStatus, errorThrown);

      // Hiển thị tên bài hát khi không có lyrics (lỗi kết nối)
      var songTitle = music_info.title || "Unknown Track";
      var songArtist = music_info.artist || "";
      var displayTitle = songTitle + (songArtist ? " - " + songArtist : "");
      ...
      // Sử dụng albumUrl từ music_info nếu có
      if (music_pic && music_info && music_info.albumUrl && music_info.albumUrl.trim() !== "") {
        console.log("API lỗi kết nối, sử dụng albumUrl từ music_info:", music_info.albumUrl);
        music_pic.src = music_info.albumUrl;
      }
    ...
    if (cached_data_str) {
      try {
        ...
        if (
          cached_data.code == 1 &&
          cached_data.data &&
          cached_data.data.id == music_id
        ) {
          console.log('Sử dụng thông tin bài hát từ cache');
    ...
    console.log('Đang gửi yêu cầu đến API:', post_data);
    $.ajax({
      type: "POST",
      url: api_url,
      data: post_data,
...
function update_lrc(force_update = false, wait_for_load = false) {
  ...
  var _update_lrc_display = () => {
    ...
    if (
      ...
      current_ms = Math.max(
        0,
        parseInt(info_time[1] + (new Date().getTime() - info_time[0]))
      );
    } else {
    ...
    if (musics_div.style.display === "block" && !time_lock) {
      if (music_time) {
        if (music_time.max != duration_ms && !isNaN(duration_ms))
          music_time.max = duration_ms;
      ...
      if (music_time_duration && !isNaN(duration_ms)) {
        ...
        if (music_time_duration.innerText != duration_str)
          music_time_duration.innerText = duration_str;
      }
      if (music_time_position) {
        var position_str = ms_to_is(current_ms);
        if (music_time_position.innerText != position_str)
          music_time_position.innerText = position_str;
      }
    }
    ...
    if (lrcs && lrcs.length > 0) {
      ...
      // Tìm các dòng lyrics có timestamp
      var timestamped_lrcs = lrcs.filter(lrc => lrc[0] !== -1);

      // Nếu không có lyrics có timestamp, hiển thị tất cả các dòng không có timestamp
      if (timestamped_lrcs.length === 0) {
        display_lrcs = lrcs.filter(lrc => lrc[1] !== "");
      } else {
        ...
        for (var idx = 0; idx < lrcs.length; idx++) {
          if (lrcs[idx][1] !== "") {
            ...
            if (lrcs[idx][0] === -1 || parseInt(lrcs[idx][0]) <= current_ms + 280) {
      ...
      if (music_lrc.style.display === "block") {
        var lrc_scroll_div =
          music_lrc.getElementsByClassName("music_lrc_div")[0];
        ...
        if (force_update || music_lrc.lrcs !== lrcs) {
          ...
          lrc_scroll_div.style =
            "width: 100%; height: 193px; overflow-x:hidden; overflow-y:auto;";
          ...
          for (var i = 0; i < Math.floor(padding_lines / 2) + 1; i++) {
            // Add top padding
        ...
        if (lrc_scroll_div && current_display_index !== -1) {
          ...
          var highlight_index =
            current_display_index + Math.floor(padding_lines / 2) + 1;
          ...
          if (lrc_h3s && lrc_h3s.length > highlight_index) {
            ...
            var needs_highlight =
              !current_line_element.classList.contains("custom_lrc");

            if (needs_highlight || force_update) {
              // Highlight if needed or forced
              ...
              var targetScrollTop =
                current_line_element.offsetTop -
                lrc_scroll_div.clientHeight / 2 +
                current_line_element.clientHeight / 2;

              // Use jQuery animate for smooth scroll if available
              if (typeof $ !== "undefined" && $.fn.animate) {
                $(lrc_scroll_div)
                  .stop()
                  .animate({ scrollTop: targetScrollTop }, 200); // Smooth scroll
              } else {
        ...
        // If lyrics display is hidden, update main H3 title
        if (current_lrc_index !== -1 && lrcs[current_lrc_index]) {
          ...
          if (
            lrc_text !== "" &&
            h3.innerHTML !== lrc_text &&
            title_display_time - new Date().getTime() <= 0
          ) {
            set_h3(lrc_text);
          }
        } else if (
      ...
      var check_interval = setInterval(() => {
        ...
        if (
          (info_time &&
            ...
            lrcs.length > 0 &&
            lrcs[0][0] !== -1) ||
          new Date().getTime() - start_time > 1500
        ) {
          // 1.5 sec timeout
...
function musicpic_background() {
  ...
  if (url && url !== music_pic.nopic && !url.startsWith("http://localhost/")) {
...
function Restore_background(default_bg = background) {
  // Allow passing default
...
function send(success_tip, type_id, ws_type, data_payload, callback = null) {
  // Renamed parameters // Added callback
  if (type_id != null) {
...
function create_set_background_page() {
  ...
  uploadpic_div.style =
    "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:350px; max-width: 90%;"; // Added max-width
  ...
  var title_div = document.createElement("div");
  title_div.style =
    "background-color: rgba(0,160,255,1);border-radius:15px 15px 0 0;"; // Only top radius
  uploadpic_div.appendChild(title_div);

  var div_title_spacer = document.createElement("div");
  div_title_spacer.style.height = "1px"; // Spacer for layout
  ...
  title.style =
    "font-size: 16px;color:#ffffff; padding: 10px; margin: 0; text-align: center;"; // Add padding, remove margin
  ...
  content_div.style =
    "background-color: #ffffff; border-radius:0 0 15px 15px; margin: 0 auto; max-height:500px; overflow-x:hidden; overflow-y:auto; padding: 15px;"; // Remove margin, add padding
  ...
  upload_input.style =
    "color:rgba(238, 0, 0, 1); height:30px; width:180px; vertical-align: middle;"; // Align vertically
  ...
  Blur_slider.addEventListener("input", function () {
    ...
    if (background_div)
      background_div.style.filter = "blur(" + blur_val + "px)";
    ...
    if (file) {
      ...
      if (file.size > max_size) {
        if (current_title_elem)
          current_title_elem.innerHTML = "Compressing large image..."; // Dịch
        try {
          ...
          if (file_to_process.size > max_size * 1.5) {
            // Check if still too large after compression
            if (current_title_elem) current_title_elem.innerHTML = title.title; // Restore title
            alert(
              "Image too large even after compression. Please use a smaller file."
            ); // Dịch
            return;
          }
        } catch (err) {
  ...
  rec_btn.onclick = function () {
    if (!confirm("Are you sure you want to restore the default background?"))
      return; // Dịch
  ...
  if (data == "" || data == null) {
    ...
    if (data.startsWith("http") || data.startsWith("data:image")) {
      img_css =
        'background: url("' +
        data +
        '") center center / cover no-repeat fixed;'; // Use center center
...
function update_list(data) {
  console.log("update_list called with data:", data);

  // Kiểm tra dữ liệu và phần tử list
  if (!data) {
  ...
  if (!list) {
    console.error("Playlist table element not found");
    return;
  }
  ...
  // Sử dụng setTimeout để tránh chặn UI
  setTimeout(function() {
    update_list1(data);
  }, 10);
}

// Cập nhật giao diện danh sách phát nhạc
function update_list1(data) {
  console.log("update_list1 called");
...
function Voice_time_reporting() {
  if (ws && ws.readyState === WebSocket.OPEN) {
    ws_send(
      JSON.stringify({
        type: "send_to_unisound",
        data: { type: "Voice_time_reporting" },
      })
    );
  }
}
...
function create_Voice_time_reporting(data) {
  ...
  if (!document.getElementById(container_id)) {
    ...
    Voice_time_reporting_div.style =
      "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:350px; max-width: 95%;"; // Adjust width
    ...
    var title_div = document.createElement("div");
    title_div.style =
      "background-color: rgba(0,160,255,1); border-radius:15px 15px 0 0;";
    Voice_time_reporting_div.appendChild(title_div);
    var title = document.createElement("h3");
    title.style =
      "font-size: 16px; color:#ffffff; padding: 10px; margin: 0; text-align: center;";
    ...
    var content_div = document.createElement("div");
    content_div.style =
      "background-color: #ffffff; border-radius:0 0 15px 15px; margin: 0 auto; max-height:500px; overflow-y:auto; padding: 15px; text-align: left;"; // Align left
    ...
    time_reporting_switch.onclick = function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "send_to_unisound",
            data: { type: "set_Time_reporting_open", open: this.checked },
          })
        );
      }
    };
    ...
    Half_an_hour_switch.onclick = function () {
      ...
      for (var i = 0; i < newList.length; i++) {
        // Iterate up to list length
        if (newList[i] > 0) {
          // Only change active hours
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "send_to_unisound",
            data: { type: "set_Time_reporting_list", list: newList },
          })
        );
      ...
      Time_reporting_12h_switch.onclick = function () {
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: { type: "set_Time_reporting_12h", open: this.checked },
            })
          );
        }
      };
    ...
    for (var i = 0; i < 24; i++) {
      ...
      div_hour_item.style =
        ...
        100 / hours_per_row +
        "%; margin-bottom: 5px;"; // Arrange in grid
      ...
      checkbox.onclick = function () {
        ...
        Time_reporting_list[hour_index] = this.checked
          ? isHalfHourEnabled
            ? 3
            : 1
          : 0;
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(
            JSON.stringify({
              type: "send_to_unisound",
              data: {
                type: "set_Time_reporting_list",
                list: Time_reporting_list,
              },
            })
          );
        }
    ...
    Whole_point_prompt_input.style =
      "height:30px; width:150px; vertical-align: middle; margin: 0 5px;";
    ...
    btn_save_whole.style =
      "margin: 0; padding: 6px 12px; vertical-align: middle;";
    btn_save_whole.onclick = function () {
      var prompt_input = document.getElementById("Whole_point_prompt");
      if (prompt_input.value !== "" && !prompt_input.value.includes("[hour]")) {
        // Require placeholder
    ...
    btn_save_half.onclick = function () {
      ...
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "send_to_unisound",
            data: { type: "set_Half_dot_prompt", prompt: prompt_input.value },
          })
        );
      }
    };
    ...
    close_btn_voice.onclick = function () {
      popup.onclose();
    };
    content_div.appendChild(close_btn_voice); // Append close button to content area
  } else {
    // Popup already exists, just ensure it's visible
    ...
    var time_reporting_switch = document.getElementById(
      "time_reporting_switch"
    );
    var Half_an_hour_switch = document.getElementById("Half_an_hour_switch");
    var Time_reporting_12h_switch = document.getElementById(
      "Time_reporting_12h_switch"
    );
    var Whole_point_prompt_input =
      document.getElementById("Whole_point_prompt"); // Use specific name
  ...
  if (time_reporting_switch)
    time_reporting_switch.checked = !!data.Time_reporting_open; // Use boolean conversion
  var isAnyHalfHour = false;
  if (Time_reporting_list && Time_reporting_list.length === 24) {
    // Check list validity
    for (var i = 0; i < 24; i++) {
  ...
  if (u_ver + 1 > 1833 && Time_reporting_12h_switch) {
    // Check element exists
    Time_reporting_12h_switch.checked = !!data.Time_reporting_12h;
  }
  if (Whole_point_prompt_input)
    Whole_point_prompt_input.value = data.Whole_point_prompt || ""; // Use empty string if null
  if (Half_dot_prompt_input)
    Half_dot_prompt_input.value = data.Half_dot_prompt || "";
}
...
function create_Auto_restart_device(data) {
  ...
  if (!document.getElementById(container_id)) {
    ...
    content_div_auto.style =
      "background-color: #ffffff; border-radius:0 0 15px 15px; margin: 0 auto; padding: 15px; text-align: left;"; // Align left
    ...
    Auto_restart_device_switch.onclick = function () {
      if (ws && ws.readyState === WebSocket.OPEN) {
        ws_send(
          JSON.stringify({
            type: "set_Auto_restart_device_open",
            open: this.checked,
          })
        );
      }
    ...
    Auto_restart_device_time_input.onchange = function () {
      // Use onchange to send after selection
      if (this.value) {
        ...
        if (time_parts.length >= 2) {
          ...
          if (!isNaN(times[0]) && !isNaN(times[1])) {
            ...
            if (ws && ws.readyState === WebSocket.OPEN) {
              ws_send(
                JSON.stringify({
                  type: "set_Auto_restart_device_time",
    ...
    close_btn_auto.onclick = function () {
      popup.onclose();
    };
    content_div_auto.appendChild(close_btn_auto);
  } else {
    // Popup exists, make sure it's visible
    if (popup.style.display !== "block") {
      popup.innerHTML = "";
      popup.appendChild(Auto_restart_device_div);
      popup.style.display = "block";
    ...
    var Auto_restart_device_switch = document.getElementById(
      "Auto_restart_device_switch"
    );
    var Auto_restart_device_time_input = document.getElementById(
      "Auto_restart_device_time"
    );
  }

  // Update control states based on received data
  if (Auto_restart_device_switch)
    Auto_restart_device_switch.checked = !!data.Auto_restart_device_open;

  if (
    Auto_restart_device_time_input &&
    Auto_restart_device_times &&
    Auto_restart_device_times.length === 2
  ) {
...
function create_text_window(title_text, value) {
  ...
  text_window_container.style =
    "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:300px; max-width: 90%; background-color: rgba(0,160,255,1); border-radius: 15px;"; // Combine styles
  ...
  content_div_text.style =
    "background-color: #ffffff; border-radius: 0 0 15px 15px; margin: 0 auto; max-height: 500px; overflow-x: hidden; overflow-y: auto; padding: 15px;"; // Padding for content
  ...
  text_display_div.style =
    "color: rgba(0, 0, 0, 1); text-align: left; white-space: pre-wrap; word-wrap: break-word;"; // Use black text, allow wrapping
  ...
  close_btn_text.onclick = function () {
    popup.onclose();
  };
...
function create_color_selection() {
  ...
  if (!document.getElementById(container_id)) {
    ...
    color_selection_div.style =
      "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:280px; max-width: 90%;"; // Adjust width
    ...
    content_div_color.style =
      "background-color: #ffffff; border-radius:0 0 15px 15px; margin: 0 auto; padding: 15px; text-align: center;"; // Center content
    ...
    color_picker_input.style =
      "width: 100px; height: 50px; vertical-align: middle; border: 1px solid #ccc; padding: 2px; cursor: pointer;"; // Basic styling
    color_picker_input.onchange = function () {
    ...
    color_picker_input.oninput = function () {
      // Live update for browsers that support it
      var color_value_input = document.getElementById("color_value");
      if (color_value_input) color_value_input.value = this.value.toUpperCase();
    };
    ...
    color_value_input.style =
      "height:30px; width:100px; vertical-align: middle; margin-left: 5px; font-family: monospace;"; // Style for hex
    color_value_input.maxLength = 7; // Limit length (#RRGGBB)
    color_value_input.onchange = function () {
      // Update picker when text input changes
      var color_picker_input = document.getElementById("color_selection");
      if (color_picker_input && /^#[0-9A-F]{6}$/i.test(this.value)) {
        // Validate hex format
    ...
    btn_save_color.onclick = function () {
      ...
      if (
        color_value_input &&
        /^#[0-9A-F]{6}$/i.test(color_value_input.value)
      ) {
        // Validate hex
    ...
    btn_cancel_color.onclick = function () {
      popup.onclose();
    };
    settings_div_color.appendChild(btn_cancel_color);
  } else {
    // Popup exists, just show it
    if (popup.style.display !== "block") {
      popup.innerHTML = "";
      popup.appendChild(color_selection_div);
      popup.style.display = "block";
...
function create_music_info_window(data) {
  ...
  if (!music_info_div) {
    ...
    music_info_div.style =
      "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:300px; max-width: 90%;";
    ...
    title_div_music.style =
      "background-color: rgba(0,160,255,1); border-radius:15px 15px 0 0; padding: 10px; display: flex; align-items: center;"; // Use flexbox
    music_info_div.appendChild(title_div_music);

    var pic = document.createElement("img");
    pic.id = "popup_music_pic"; // ID for updating later
    pic.style =
      "border-radius: 10%; height: 60px; width: 60px; margin-right: 10px; object-fit: cover; background-color: #eee;"; // Style cover
    ...
    div_text_container.style =
      "display: flex; flex-direction: column; overflow: hidden;"; // Column layout for text
    ...
    title_text.style =
      "font-size: 15px; font-weight: bold; color: #ffffff; text-align:left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"; // Style title
    ...
    artist_text.style =
      "font-size: 12px; color: #ffffff; text-align:left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"; // Style artist
    ...
    option_div.style =
      "background-color: #ffffff; border-radius:0 0 15px 15px; max-height:400px; overflow-y:auto;";
    music_info_div.appendChild(option_div);
  } else {
    // Popup exists, update content
    ...
    if (option_div)
      option_div.innerHTML =
        '<div class="span1" style="padding: 10px;">Loading options...</div>'; // Dịch placeholder while fetching details
  }
  ...
  option_list.push({
    ...
    onclick: function () {
      if (List && List.playIndex == data.index) {
  ...
  if (is_new_unisound) {
    option_list.push({
      ...
      onclick: function () {
        if (!temp_api_musicinfo) {
          alert("Song details not loaded yet.");
          return;
        } // Wait for API info // Dịch
        if (
          !confirm(
            "Are you sure you want to favorite [" +
              get_music_title(temp_api_musicinfo) +
              "]?"
          )
        ) {
          // Dịch
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ...
          ws_send(
            JSON.stringify({
              ...
              data: {
                type: "api",
                data: { type: "collect", music_info: info_to_send },
              },
            })
          );
        }
        ...
        if (ws && ws.readyState === WebSocket.OPEN) {
          ...
          ws_send(
            JSON.stringify({
              ...
              data: {
                type: "api",
                data: { type: "cancel_collect", music_info: info_to_send },
              },
            })
          );
        }
  ...
  option_list.push({
    ...
    onclick: function () {
      ...
      var types = {
        ...
        kugou: "Kugou Music",
        migu: "Migu Music",
        "5singyc": "5sing Original",
        "5singfc": "5sing Cover",
        "5singbz": "5sing Accompaniment",
      };
      var text_arr = [];
      ...
      if (temp_api_musicinfo.link) {
        // Make ID clickable if link exists
      ...
      if (typeof temp_api_musicinfo.lrc == "string") {
        var raw_lrc_info = temp_api_musicinfo.lrc
          .replace(/\[/g, "\r\n[")
          .replace(/\r\n\r\n/g, "\r\n")
          .trim();
  ...
  if (song_info.itemId && song_info.itemId.startsWith("local_")) {
    ...
    post_data_info = {
      info: song_info.itemId,
      file: song_info.title,
      metadata: JSON.stringify(Current_MusicData?.MediaMetadata || null),
    };
  } else {
    post_data_info = {
      info: song_info.itemId,
      music_info: JSON.stringify(song_info || null),
    };
  }

  // API Success Handler
  var success_callback_info = function (api_response) {
    // Use specific name
    ...
    if (api_response.code == 1) {
      ...
      if (pic_update)
        pic_update.src = temp_api_musicinfo.pic || "./pic/nopic.jpg";
      if (title_update)
        title_update.innerHTML =
          temp_api_musicinfo.name || song_info.title || "Unknown Title"; // Dịch
      if (artist_update)
        artist_update.innerHTML =
          temp_api_musicinfo.artist || song_info.artist || "";

      // Add options to the popup
      option_list.forEach((option, index) => {
        // Check if the option requires API info and if we have it
        var enable_option =
          !option.requiresApiInfo ||
          (option.requiresApiInfo && temp_api_musicinfo);
        // Add separator
        if (index > 0) {
          var hr = document.createElement("hr");
          hr.className = "hr";
      ...
      // API Error
      option_div_update.innerHTML =
        '<div class="span1" none="true" style="padding: 10px;">Failed to load song details.</div>'; // Dịch error

      // Hiển thị thông tin cơ bản về bài hát nếu có
      if (data.music_info) {
        var basicInfo = document.createElement("div");
        basicInfo.className = "span1";
        basicInfo.style.padding = "10px";
        basicInfo.style.borderTop = "1px solid #eee";

        var songTitle = data.music_info.title || "Unknown Title";
        var songArtist = data.music_info.artist || "";
        var displayTitle = songTitle + (songArtist ? " - " + songArtist : "");

        basicInfo.innerHTML = "<strong>Bài hát:</strong> " + displayTitle;
        option_div_update.appendChild(basicInfo);
      }

      // Thêm nút Play Song ngay cả khi không tải được thông tin chi tiết
      var hr_play = document.createElement("hr");
      hr_play.className = "hr";
      hr_play.style.margin = "0";
      hr_play.style.borderTop = "1px solid #eee";
      option_div_update.appendChild(hr_play);

      var tr_play = document.createElement("tr");
      tr_play.className = "span1";
      tr_play.style.display = "block";
      tr_play.style.color = "#007bff";
      tr_play.style.fontWeight = "bold";
      tr_play.onclick = function () {
        if (List && List.playIndex == data.index) {
          // Check if already playing
          popup.onclose();
          return;
        ...
        // Gửi lệnh phát bài hát
        if (ws && ws.readyState === WebSocket.OPEN) {
          ws_send(JSON.stringify({ type: "play", index: data.index }));

          // Cập nhật trạng thái "[Đang phát]" ngay lập tức
          updatePlayingStatus(data.index);
        } else {
          send(null, null, "play", { index: data.index }); // Fallback
        }

        popup.onclose();
      };
      var span_play = document.createElement("span");
      span_play.innerHTML = "Phát bài hát";
      tr_play.appendChild(span_play);
      option_div_update.appendChild(tr_play);

      // Thêm nút Add to Playlist nếu có chức năng này
      if (ws && ws.readyState === WebSocket.OPEN && data.music_info && data.music_info.id) {
        var hr_add = document.createElement("hr");
        hr_add.className = "hr";
        hr_add.style.margin = "0";
        hr_add.style.borderTop = "1px solid #eee";
        option_div_update.appendChild(hr_add);

        var tr_add = document.createElement("tr");
        tr_add.className = "span1";
        tr_add.style.display = "block";
        tr_add.onclick = function () {
          // Gửi lệnh thêm vào danh sách phát (nếu API hỗ trợ)
          // ws_send(JSON.stringify({ type: "add_to_playlist", id: data.music_info.id }));
          alert("Chức năng này chưa được hỗ trợ");
          popup.onclose();
        };
        var span_add = document.createElement("span");
        span_add.innerHTML = "Thêm vào danh sách phát";
        tr_add.appendChild(span_add);
        option_div_update.appendChild(tr_add);
      }

      // Still add the Cancel button
      var hr_cancel = document.createElement("hr");
      hr_cancel.className = "hr";
      hr_cancel.style.margin = "0";
      hr_cancel.style.borderTop = "1px solid #eee";
      option_div_update.appendChild(hr_cancel);
      var tr_cancel = document.createElement("tr");
      tr_cancel.className = "span1";
      tr_cancel.style.display = "block";
      tr_cancel.onclick = function () {
        popup.onclose();
      };
      var span_cancel = document.createElement("span");
      span_cancel.innerHTML = "Đóng";
      tr_cancel.appendChild(span_cancel);
      option_div_update.appendChild(tr_cancel); // Dịch
    }
  };
  ...
  var error_callback_info = function () {
    ...
    if (option_div_update) {
      option_div_update.innerHTML =
        '<div class="span1" none="true" style="padding: 10px;">Error fetching song details.</div>'; // Dịch error
  ...
  if (cached_info_str) {
    try {
      ...
      if (
        cached_info.code == 1 &&
        cached_info.data &&
        cached_info.data.id == song_info.itemId
      ) {
...
function get_song_list(data) {
  console.log("get_song_list called with data:", data);

  // Kiểm tra dữ liệu
  if (!data) {
    console.error("No song list data received");
    create_song_list_window({
      code: "error",
      msg: "Không nhận được dữ liệu danh sách bài hát"
    });
    return;
  }

  if (data.code == "200" || data.code == 200) {
    // API uses string or number code '200'
    console.log("Successfully received song list data");
    ...
    if (!data.msg) {
      data.msg = "Không thể tải danh sách bài hát. Vui lòng thử lại sau.";
    }
  }

  // Hiển thị cửa sổ danh sách bài hát
  create_song_list_window(data); // Update the UI with fetched data or error state

  // Yêu cầu cập nhật danh sách phát hiện tại nếu cần
  if (ws && ws.readyState === WebSocket.OPEN && list && (!list.rows || list.rows.length === 0)) {
    console.log("Requesting current playlist update");
    ws_send(JSON.stringify({ type: "list" }));
  }
}

// Cập nhật danh sách phát nhạc
function update_list(data) {
  console.log("update_list called with data:", data);
  ...
  if (!data || !data.playList || data.playList.length < 1) {
    ...
    list.innerHTML = '';
    var list_title = document.getElementById('list_title');
    if (list_title) list_title.innerHTML = 'Danh sách phát [0]';
    return;
  }

  // Lưu trữ dữ liệu danh sách
  List = data;
...
function update_list1(data) {
  ...
  // Lấy chỉ số bài hát đang phát
  var play_index = data.playIndex;

  // Xóa danh sách cũ nếu số lượng hàng hiện tại nhiều hơn số lượng bài hát
  if (list.rows && list.rows.length > data.playList.length) {
    list.innerHTML = '';
  }

  // Tạo hoặc cập nhật các hàng trong danh sách
  for (var i = 0; i < data.playList.length; i++) {
    var tr = list.rows && list.rows[i] ? list.rows[i] : null;
    ...
    if (!tr) {
      ...
      // Bỏ qua nếu hàng đã tồn tại và không phải là bài đang phát
      if (tr.getAttribute('playing') != 'true' && tr.getAttribute('itemId') == data.playList[i].itemId) {
        continue;
      }

      // Xóa nội dung cũ và đặt lại trạng thái
      tr.innerHTML = '';
  ...
  // Đánh dấu bài hát đang phát
  if (play_index > -1 && list.rows && list.rows[play_index]) {
    var tr = list.rows[play_index];
    var span = document.createElement('span');
  ...
  // Thiết lập sự kiện click cho danh sách
  list.onclick = function(event) {
    ...
    // Lưu trữ hàng được click
    list.old_click_tr = list.click_tr;
    list.click_tr = tr;

    // Hiển thị thông tin bài hát khi click
    listonclick_timer = setTimeout(function() {
      if (tr) {
        var index = parseInt(tr.getAttribute('index'));
        if (!isNaN(index) && List && List.playList && List.playList[index]) {
  ...
  // Thiết lập sự kiện double click để phát bài hát
  list.ondblclick = function(event) {
    clearTimeout(listonclick_timer);

    // Tìm hàng được double click
    var tr = null;
    var target = event.target;
    ...
    if (tr) {
      // Kiểm tra xem có phải là cùng một hàng đã click trước đó
      if (list.old_click_tr && list.old_click_tr.getAttribute('index') !== tr.getAttribute('index')) {
        return;
      }

      // Không làm gì nếu đây là bài đang phát
      ...
      if (index !== null && ws && ws.readyState === WebSocket.OPEN) {
        ws_send(JSON.stringify({ type: 'play', index: index }));
      }
    }
  };
  ...
  // Cuộn đến bài hát đang phát
  if (play_index > -1 && lists && lists.style.display !== 'none' && list.rows && list.rows[play_index]) {
    lists.scrollTop = list.rows[play_index].offsetTop - 50;
  }
}

// Creates or updates the popup window displaying user playlists
function create_song_list_window(data) {
  // data is the raw response from get_song_list or API
  ...
  if (!song_list_container) {
    ...
    song_list_container.style =
      "position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width: auto;min-width:350px; max-width: 90%; background-color: rgba(0,160,255,1); border-radius: 15px;";
    ...
    title_sl.style =
      "display: block; font-size: 16px; font-weight: bold; color: #ffffff; padding: 10px; text-align: center;";
    ...
    content_div_sl.style =
      "background-color: #ffffff; border-radius: 0 0 15px 15px; margin: 0 auto; max-height: 500px; overflow-x: hidden; overflow-y: auto; text-align: left;";
    // Adjust max height based on viewport
    if (document.body.clientHeight < 600) {
    ...
    content_div_sl.onclick = function (event) {
      // Use event parameter
      ...
      while (click_target && click_target !== content_div_sl) {
        if (
          click_target.classList &&
          click_target.classList.contains("click")
        ) {
      ...
      if (playlist_item_div) {
        // If a playlist item was clicked
        var playlist_id = playlist_item_div.getAttribute("id");
        var playlist_title_elem = playlist_item_div.querySelector(
          "text1:first-of-type"
        ); // Find title element more reliably
        var playlist_title = playlist_title_elem
          ? playlist_title_elem.innerHTML
          : "Unknown Playlist";

        if (!confirm("Play playlist [" + playlist_title + "]?")) {
          // Dịch confirmation
          return;
        }
  ...
  if (song_list_content_div && song_list_title_elem) {
    ...
    if (data === null) {
      // Still loading state
      song_list_title_elem.innerHTML = "Đang tải danh sách..."; // Dịch
      song_list_content_div.innerHTML =
        '<div class="span1" style="padding: 10px;">Vui lòng đợi...</div>'; // Dịch
    } else if ((data.code == 200 || data.code == "200") && data.data) {
      // Success - kiểm tra cả code dạng số và chuỗi
      console.log("Displaying playlist data:", data);

      // Xử lý cấu trúc dữ liệu khác nhau
      var list_data = {};
      var title = "Danh sách phát của tôi"; // Default title

      if (data.data.data) {
        // Cấu trúc cũ: data.data.data chứa các nhóm playlist
        list_data = data.data.data;
        title = data.data.title || title;
      } else if (Array.isArray(data.data)) {
        // Cấu trúc mới: data.data là mảng các playlist
        list_data = { "default": { title: "Danh sách phát", list: data.data } };
      } else if (typeof data.data === 'object') {
        // Cấu trúc khác: data.data là một đối tượng
        list_data = { "default": { title: "Danh sách phát", list: [data.data] } };
      }

      song_list_title_elem.innerHTML = title;

      if (Object.keys(list_data).length === 0) {
        // Handle empty playlist list
        song_list_content_div.innerHTML =
          '<div class="span1" style="padding: 10px;">Không tìm thấy danh sách phát nào.</div>'; // Dịch
      } else {
        ...
        for (var group_key in list_data) {
          if (list_data.hasOwnProperty(group_key)) {
            ...
            if (!group_list || group_list.length === 0) {
              continue; // Bỏ qua nhóm trống
            }

            // Add group title
            var div_group_title = document.createElement("div");
            div_group_title.style =
              "font-size: 14px; color: #555; margin: 10px 5px 5px 10px; font-weight: bold;";
            div_group_title.innerHTML =
              (group.title || "Nhóm danh sách phát") +
              " [" +
              group_list.length +
              "]"; // Dịch group title
            ...
            group_list.forEach((item) => {
              if (!item) return; // Bỏ qua mục không hợp lệ

              var item_div = document.createElement("div");
              item_div.className = "click"; // Class for styling and click handling
              item_div.setAttribute("id", item.id || "unknown"); // Store playlist ID
              item_div.style = "border-top: 1px solid #eee; padding: 5px;"; // Add separator and padding

              var pic = document.createElement("img");
              pic.style =
                "border-radius: 5px; margin: 5px 10px 5px 5px; height: 50px; width: 50px; vertical-align: middle; object-fit: cover; background-color: #eee;"; // Adjust size
              pic.src = item.pic || "./pic/nopic.jpg"; // Use cover or placeholder
              pic.onerror = function() {
                this.src = "./pic/nopic.jpg"; // Fallback if image fails to load
              };
              item_div.appendChild(pic);

              var text_div = document.createElement("div");
              text_div.style =
                "display: inline-block; vertical-align: middle; width: calc(100% - 75px);"; // Adjust width calculation

              var title1 = document.createElement("div"); // Use div instead of non-standard text1
              title1.style =
                "font-size: 15px; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #333;"; // Style title
              title1.innerHTML = item.title || "Danh sách phát không tên"; // Dịch
              text_div.appendChild(title1);

              var content1 = document.createElement("div"); // Use div instead of non-standard text1
              content1.style =
                "font-size: 11px; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #777;"; // Style content
              content1.innerHTML = item.content || (item.count ? item.count + " bài hát" : ""); // e.g., track count
              ...
              item_div.onclick = function() {
                var playlist_id = this.getAttribute("id");
                var playlist_title = this.querySelector("div").innerHTML;

                if (confirm("Phát danh sách [" + playlist_title + "]?")) {
                  if (ws && ws.readyState === WebSocket.OPEN) {
                    ws_send(
                      JSON.stringify({
                        type: "send_message",
                    ...
                    alert("Lỗi kết nối, không thể phát danh sách.");
                  }
                }
              };
            });
      ...
      // Error code from our custom error handling
      song_list_title_elem.innerHTML = "Lỗi tải danh sách"; // Dịch
      song_list_content_div.innerHTML =
        '<div class="span1" none="true" style="padding: 10px;">' +
        (data.msg || "Không thể tải danh sách phát.") +
        "</div>"; // Dịch error message
    } else {
      // Other error fetching playlists
      song_list_title_elem.innerHTML = "Lỗi tải danh sách"; // Dịch
      song_list_content_div.innerHTML =
        '<div class="span1" none="true" style="padding: 10px;">' +
        (data.msg || "Không thể tải danh sách phát. Mã lỗi: " + (data.code || "không xác định")) +
        "</div>"; // Dịch error message with code
    }
  }
}
    ...
    reader.onload = function (e) {
      img.onload = function () {
        ...
        canvas.toBlob(
          ...
          "image/jpeg",
          quality
        ); // Specify JPEG format and quality
      };
...
function get_background_color(x, y, callback) {
  console.warn(
    "get_background_color relies on a specific Canvas library (getPixelColor) which is not included. Returning default color."
  );
...
function get_background_color1(callback) {
  console.warn(
    "get_background_color1 relies on get_background_color which may not work. Returning default."
  );
...
function update_StatusBar(is_dark_background = false) {
  // Added parameter hint
  if (typeof plus != "undefined") {
    // Check if PlusRuntime API exists
    var StatusBar_div = document.getElementById("StatusBar");
    if (!StatusBar_div) {
      // Create status bar placeholder if it doesn't exist
      StatusBar_div = document.createElement("div");
      StatusBar_div.id = "StatusBar";
      StatusBar_div.style =
        "width: 100%; position: fixed; top: 0; left: 0; z-index: 10; background-color: transparent;"; // Basic style
      document.body.insertBefore(StatusBar_div, document.body.firstChild);
    }

    try {
      // Wrap PlusRuntime calls in try-catch
      if (plus.navigator.isImmersedStatusbar()) {
        // Immersive/Transparent status bar mode
        ...
        var WindowManager = plus.android.importClass(
          "android.view.WindowManager"
        );
        var View = plus.android.importClass("android.view.View");
        window_android.clearFlags(
  ...
  if (main_div) {
    ...
    main_div.style.backgroundColor =
      Cover_background_open && music_pic && music_pic.src !== music_pic.nopic
        ? "rgba(19, 16, 66, 0.6)"
        : "rgba(0,0,0,0.0)";
  }
  // Apply blur effect from storage
  var BackgroundBlurValue =
    Storage.getItem(hostname + "_BackgroundBlur") || "0";
  if (background_div)
...
function setparam_arr(params) {
  ...
  try {
    // Add try-catch for replaceState
...
function load() {
  ...
  if (location.href.includes("type=message")) {
    // Special mode for iframe storage sync
  ...
  document.addEventListener(
    ...
    function () {
      if (typeof plus !== "undefined") {
        ...
        try {
          // Add try-catch for Plus features
          plus.webview
            .currentWebview()
            .overrideUrlLoading({ mode: "allow", match: ".*wxfsq.*" }, (e) =>
              plus.runtime.openURL(e.url)
            );
        } catch (e) {
          console.error("Error setting URL override:", e);
        }
      }
    },
    false
  ...
  divs.id = "divs";
  divs.style =
    "text-align: center; display:block; margin:0px auto; padding: 0 5px;"; // Add padding
  ...
  popup.onclose = function () {
    ...
    setTimeout(() => {
      // Delay clearing to allow animations
      popup.innerHTML = "";
  ...
  script_jq.onerror = function () {
    console.error(
      "Failed to load jQuery from primary source. Trying fallback..."
    ); // Dịch
  ...
  div_footer.style =
    "position: fixed; bottom: 0; left: 0; right: 0; padding: 3px 5px; display: flex; justify-content: space-between; align-items: center; font-size: 11px; background-color: rgba(255, 255, 255, 0.1); backdrop-filter: blur(2px); z-index: 5;"; // Basic footer styling

  var div_qq = document.createElement("div");
  div_qq.id = "qun_div";
  // Style adjusted for footer
  div_qq.innerHTML =
    "<a id='qun' style='color:rgba(238, 0, 0, 1); text-decoration: none;' target='_blank' href='https://fb.com/xuan2261'>Facebook: fb.com/xuan2261</a>";
...
function load_console() {
  ...
  script.onerror = function () {
    ...
    script_fallback.src =
      "https://unpkg.com/vconsole@latest/dist/vconsole.min.js"; // Use CDN
...
function setCookie(cname, cvalue, exdays) {
  ...
  document.cookie =
    ...
    ";" +
    expires +
    ";path=/;SameSite=Lax"; // Encode value, specify path
}
